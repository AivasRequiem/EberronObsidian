...
> [!gallery]
> ![Wave Echo Cave](Інструменти%20ДМ/CLI/adventures/lost-mine-of-phandelver/img/wave-echo-cave.webp#gallery)
> ![Player Version](Інструменти%20ДМ/CLI/adventures/lost-mine-of-phandelver/img/wave-echo-cave-player.webp#gallery)
...
None unless otherwise indicated. The boxed text assumes that the characters have light sources or [darkvision](Інструменти%20ДМ/CLI/rules/senses.md#Darkvision).
...
Tharden wears a pair of [boots of striding and springing](Інструменти%20ДМ/CLI/items/boots-of-striding-and-springing-xdmg.md). In his haste to explore the rest of Wave Echo Cave, Nezznar overlooked them.
...
Clinging to the ceiling like bats are ten [stirges](Інструменти%20ДМ/CLI/bestiary/monstrosity/stirge-xmm.md). The monsters find scant living prey in the mines, and they are ravenous. If the characters are looking down at the skeletons on the floor, the stirges are likely get the drop on them. Any character who isn't watching the ceiling is [surprised](Інструменти%20ДМ/CLI/rules/conditions.md#Surprised) unless his or her passive Wisdom ([Perception](Інструменти%20ДМ/CLI/rules/skills.md#Perception)) score is higher than the stirges' Dexterity ([Stealth](Інструменти%20ДМ/CLI/rules/skills.md#Stealth)) check total (roll once for all of them). Characters who aren't [surprised](Інструменти%20ДМ/CLI/rules/conditions.md#Surprised) hear a flapping noise as the stirges descend to attack.
...
In the round after any living creature enters this chamber, the bones begin to stir and knit together, forming nine [skeletons](Інструменти%20ДМ/CLI/bestiary/undead/skeleton-xmm.md). They fight until destroyed.
...
Behind the counter sits a locked iron strongbox, requiring [thieves' tools](Інструменти%20ДМ/CLI/items/thieves-tools-xphb.md) and a successful DC 20 Dexterity check to open. This pay chest was overlooked in the fighting and contains 600 cp, 180 sp, 90 ep, and 60 gp.

## 6. South Barracks

This was a miners' barracks, where the skilled delvers working in Wave Echo Cave rested between shifts. Any character who listens at the partially open door hears faint crunching and splintering sounds with a successful DC 10 Wisdom ([Perception](Інструменти%20ДМ/CLI/rules/skills.md#Perception)) check.
...
Three [ghouls](Інструменти%20ДМ/CLI/bestiary/undead/ghoul-xmm.md) from the pack in 9 are here, cracking and gnawing on the ancient bones of the fallen in the vain hope that some tasty morsel of marrow remains. The ghouls, eager for a fresh meal, attack immediately.
...
Most of the fungi is harmless, and the green-glowing fungi allow creatures to see the entire cavern without the aid of [darkvision](Інструменти%20ДМ/CLI/rules/senses.md#Darkvision) or a light source.
...
Seven [ghouls](Інструменти%20ДМ/CLI/bestiary/undead/ghoul-xmm.md) lurk in the shadows on the western ledge.
...
The skeleton wears two platinum rings (75 gp each) and clutches a [wand of magic missiles](Інструменти%20ДМ/CLI/items/wand-of-magic-missiles-xdmg.md) in its bony fingers.

## 11. North Barracks

The eastern door is barricaded from inside the room and requires a successful DC 20 Strength check to force open. A character who listens at either door and succeeds on a DC 10 Wisdom ([Perception](Інструменти%20ДМ/CLI/rules/skills.md#Perception)) check hears gruff voices speaking Goblin and talking about how hungry they are.
...
The largest bugbear carries a pouch containing 15 cp. 13ep, and a [potion of vitality](Інструменти%20ДМ/CLI/items/potion-of-vitality-xdmg.md).
...
Eight of the fallen dwarf warriors are [zombies](Інструменти%20ДМ/CLI/bestiary/undead/zombie-xmm.md). They rise and pursue any living creatures that enter the room, but they do not pursue creatures outside this area for more than 1 round. In addition, a far more intelligent undead guards this area: a [flameskull](Інструменти%20ДМ/CLI/bestiary/undead/flameskull-xmm.md). This creature was a servant of the human wizards allied with the Phandelver dwarves and gnomes, and it continues to act on ancient instructions to prevent intruders from passing through.
...
Any character proficient in [Arcana](Інструменти%20ДМ/CLI/rules/skills.md#Arcana) can sense a subtle aura of magic in this cavern. (A [detect magic](Інструменти%20ДМ/CLI/spells/detect-magic-xphb.md) spell reveals the same.) The aura becomes stronger as one approaches the northern building (15).
...
This room contains the restless spirit of the last wizard to die here: [Mormesk the wraith](Інструменти%20ДМ/CLI/bestiary/npc/mormesk-the-wraith-lmop.md). He is not immediately visible but rises up out of the floor when a living creature enters the room.

Mormesk was a powerful mage until he met his end in the spell battle at the climax of the orc attack. Centuries of anger have [poisoned](Інструменти%20ДМ/CLI/rules/conditions.md#Poisoned) his soul, transforming him into a hate-filled apparition.
...
On the worktable in the southeast corner of the room are the last items the spectator was charged to protect: [Lightbringer](Інструменти%20ДМ/CLI/items/lightbringer-lmop.md) and [Dragonguard](Інструменти%20ДМ/CLI/items/dragonguard-lmop.md).
...
Three [bugbears](Інструменти%20ДМ/CLI/bestiary/fey/bugbear-warrior-xmm.md) are stationed here. Two of them are clearing rock on the rift floor while one more stands guard in the western half of the cavern. A [doppelganger](Інструменти%20ДМ/CLI/bestiary/monstrosity/doppelganger-xmm.md) named Vhalak supervises the operation in the guise of a male drow. If a fight breaks out in the main cavern, the two bugbears in the rift climb up the ropes to join the fray.
...
Nezznar's divinations are accurate. Buried under heavy rubble at the bottom of the rift is the crushed skeleton of a dwarf wearing [gauntlets of ogre power](Інструменти%20ДМ/CLI/items/gauntlets-of-ogre-power-xdmg.md). The remains are hidden from view but can be found with a successful DC 20 Wisdom ([Perception](Інструменти%20ДМ/CLI/rules/skills.md#Perception)) check. Each character searching can attempt one check per hour.
...
[Nezznar the Black Spider](Інструменти%20ДМ/CLI/bestiary/npc/nezznar-the-black-spider-lmop.md) is joined by four [giant spiders](Інструменти%20ДМ/CLI/bestiary/beast/giant-spider-xmm.md) that defend their master to the death. If they are expecting trouble, the spiders hide behind pillars, and Nezznar casts [invisibility](Інструменти%20ДМ/CLI/spells/invisibility-xphb.md) on himself and stands near the table. Make a Dexterity ([Stealth](Інструменти%20ДМ/CLI/rules/skills.md#Stealth)) check for the spiders. When intruders appear, the spiders try to entangle them in webs before closing to melee range. Nezznar joins the fray on the round after the spiders attack.

If the [doppelganger](Інструменти%20ДМ/CLI/bestiary/monstrosity/doppelganger-xmm.md) from 18 retreated to this area, it assumes the guise of [Nundro Rockseeker](Інструменти%20ДМ/CLI/bestiary/npc/nundro-rockseeker-lmop.md) so that Nezznar can use the "dwarf" as leverage to force the party's surrender (although the drow won't actually harm the doppelganger). See the "Roleplaying Nezznar" section for more information on the drow villain.
...
If the characters capture Nezznar and deliver him to the townmaster's hall in Phandalin, the drow is locked up until [Sildar Hallwinter](Інструменти%20ДМ/CLI/bestiary/npc/sildar-hallwinter-lmop.md) or another representative of the Lords' Alliance can escort him to Neverwinter to face justice and interrogation. However, unless the characters post guards outside Nezznar's cell, Halia Thornton (see page 17) breaks him out of jail, smuggles him out of Phandalin, and delivers him into the waiting arms of the Zhentarim. The Zhents want to learn everything the Black Spider knows about Wave Echo Cave. What happens to Nezznar at that point is up to you.

### Treasure

Nezznar carries a [potion of healing](Інструменти%20ДМ/CLI/items/potion-of-healing-xdmg.md) and a [spider staff](Інструменти%20ДМ/CLI/items/spider-staff-lmop.md). In addition, the drow carries an iron key with a head shaped like an anvil. This key unlocks the door to 20.
...
If Nezznar is captured alive and delivered to [Sildar Hallwinter](Інструменти%20ДМ/CLI/bestiary/npc/sildar-hallwinter-lmop.md) or Townmaster Wester in Phandalin, award the party double his XP value.

## 20. Priests' Quarters

The door to this room is locked, requiring [thieves' tools](Інструменти%20ДМ/CLI/items/thieves-tools-xphb.md) and a successful DC 15 Dexterity check to open. Nezznar (19) carries the key.
...
> [!readaloud] 
> 
> Dusty draperies adorn the walls of this room, which also contains a bed and brazier. A badly disheveled dwarf lies bound and [unconscious](Інструменти%20ДМ/CLI/rules/conditions.md#Unconscious) on the cold stone floor.
^195

This room formerly belonged to the priest in charge of Dumathoin's temple (19), but Nezznar has appropriated it for use as a cell. The figure lying on the floor is [Nundro](Інструменти%20ДМ/CLI/bestiary/npc/nundro-rockseeker-lmop.md), a dwarf [commoner](Інструменти%20ДМ/CLI/bestiary/humanoid/commoner-xmm.md) and the youngest of the three Rockseeker brothers. Nezznar spared him because he thought the dwarf might know more about the mine than he admitted. The drow has interrogated Nundro harshly once or twice a day ever since capturing him.
...
Gundren and [Nundro Rockseeker](Інструменти%20ДМ/CLI/bestiary/npc/nundro-rockseeker-lmop.md) take over administration of the new mine. For the adventurers' service to their family, they gladly award the party a 10 percent share of the mine's profits. If the characters want to remain in Phandalin and perhaps restore Tresendar Manor or establish homes of their own, the people of the area are glad to have them stay. Even if they choose to move on in search of new adventures, they'll always have a warm welcome in Phandalin.
