...
- Wood Woad
---
# [Wood Woad](Інструменти ДМ\CLI\bestiary\plant/wood-woad-mpmm.md)
...
"cr": "5"
"traits":
  - "desc": "The wood woad has advantage on Dexterity ([Stealth](Інструменти%20ДМ\
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: dice:1d20+7|noform|noparens|text(+7) to hit,\
      \ reach 5 ft., one target. Hit: dice:4d4+4|noform|noparens|avg|text(14)\
      \ (4d4 + 4) force damage."
    "name": "Club"
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/plant/token/wood-woad-mpmm.webp"
```
^statblock
