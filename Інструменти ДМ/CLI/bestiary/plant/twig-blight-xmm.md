...
- Twig Blight
---
# [Twig Blight](Інструменти ДМ\CLI\bestiary\plant/twig-blight-xmm.md)
...
"cr": "1/8"
"traits":
  - "desc": "The blight has [Advantage](Інструменти%20ДМ/CLI/rules/variant-rules/advantage-xphb.md)\
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/plant/token/twig-blight-xmm.webp"
```
^statblock
