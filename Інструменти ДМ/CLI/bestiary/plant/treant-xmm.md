...
- Treant
---
# [Treant](Інструменти ДМ\CLI\bestiary\plant/treant-xmm.md)
...
"actions":
  ...
  - "desc": "The treant magically animates up to two trees it can see within 60 feet\
      ...
      \ takes its turn immediately after the treant on the same [Initiative](Інстр\
      ументи%20ДМ/CLI/rules/variant-rules/initiative-xphb.md) count, and it obeys\
      \ the treant. A tree remains animate for 1 day or until it dies, the treant\
      \ dies, or it is more than 120 feet from the treant. The tree then takes root\
      \ if possible."
    "name": "Animate Trees (1/Day)"
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/plant/token/treant-xmm.webp"
```
^statblock
