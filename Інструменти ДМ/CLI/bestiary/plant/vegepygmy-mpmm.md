...
- Vegepygmy
---
# [Vegepygmy](Інструменти ДМ\CLI\bestiary\plant/vegepygmy-mpmm.md)
*Source: Mordenkainen Presents: Monsters of the Multiverse p. 252*  

Typical vegepygmies originate from the remains left behind when a Humanoid or a Giant is killed by [russet mold](Інструменти%20ДМ/CLI/traps-hazards/russet-mold-vgm.md). One or more vegepygmies emerge from the corpse a day later.
...
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/plant/token/vegepygmy-mpmm.webp"
```
^statblock
