...
"actions":
  ...
  - "desc": "If the commander has taken damage during this combat, it gives itself\
      \ advantage on attack rolls until the end of its next turn, and dice:1d4+1|noform|noparens|avg\
      \ (1d4 + 1) [sword wraith warriors](Інструменти%20ДМ/CLI/bestiary/undead/sword-wraith-warrior-mpmm.md)\
