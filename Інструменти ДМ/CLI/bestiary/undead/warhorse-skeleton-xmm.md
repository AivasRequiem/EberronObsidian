...
- Warhorse Skeleton
---
# [Warhorse Skeleton](Інструменти ДМ\CLI\bestiary\undead/warhorse-skeleton-xmm.md)
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/undead/token/warhorse-skeleton-xmm.webp"
```
^statblock
