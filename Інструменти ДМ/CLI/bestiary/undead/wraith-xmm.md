...
- Wraith
---
# [Wraith](Інструменти ДМ\CLI\bestiary\undead/wraith-xmm.md)
...
"actions":
  ...
  - "desc": "The wraith targets a Humanoid corpse within 10 feet of itself that has\
      \ been dead for no longer than 1 minute. The target's spirit rises as a [Specter](І\
      нструменти%20ДМ/CLI/bestiary/undead/specter-xmm.md) in the space of its corpse\
      \ or in the nearest unoccupied space. The specter is under the wraith's control.\
      \ The wraith can have no more than seven specters under its control at a time."
    "name": "Create Specter"
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/undead/token/wraith-xmm.webp"
```
^statblock
