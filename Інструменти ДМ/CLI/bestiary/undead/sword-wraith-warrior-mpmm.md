...
---
# [Sword Wraith Warrior](Інструменти ДМ\CLI\bestiary\undead/sword-wraith-warrior-mpmm.md)
...
"ac": !!int "16"
"ac_class": "[chain shirt](Інструменти%20ДМ/CLI/items/chain-shirt-xphb.md), [shield](І\
...
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/undead/token/sword-wraith-warrior-mpmm.webp"
```
^statblock
