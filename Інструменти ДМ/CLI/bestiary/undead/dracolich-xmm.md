...
- Dracolich
---
# [Dracolich](Інструменти ДМ\CLI\bestiary\undead/dracolich-xmm.md)
...
"traits":
  ...
  - "desc": "Creatures within 60 feet of the dracolich can't regain [Hit Points](І\
      нструменти%20ДМ/CLI/rules/variant-rules/hit-points-xphb.md)."
    "name": "Life Suppression"
  - "desc": "The dracolich has [Advantage](Інструменти%20ДМ/CLI/rules/variant-rules/advantage-xphb.md)\
...
"legendary_actions":
  - "desc": "The dracolich moves up to half its [Speed](Інструменти%20ДМ/CLI/rules/variant-rules/speed-xphb.md),\
    ...
    "name": "Pounce"
  - "desc": "The dracolich uses Spellcasting to cast [Ray of Sickness](Інструменти\
