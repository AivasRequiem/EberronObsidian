...
- Skeleton
---
# [Skeleton](Інструменти ДМ\CLI\bestiary\undead/skeleton-xmm.md)
...
"actions":
  - "desc": "Melee Attack Roll: dice:1d20+5|noform|noparens|text(+5), reach 5\
    ...
    "name": "Shortsword"
  - "desc": "Ranged Attack Roll: dice:1d20+5|noform|noparens|text(+5), range 80/320\
      \ ft. Hit: dice:1d6+3|noform|noparens|avg|text(6) (1d6 + 3) Piercing damage."
    "name": "Shortbow"
"source":
  - "XMM"
  - "XPHB"
"image": "Інструменти%20ДМ/CLI/bestiary/undead/token/skeleton-xmm.webp"
```
^statblock
