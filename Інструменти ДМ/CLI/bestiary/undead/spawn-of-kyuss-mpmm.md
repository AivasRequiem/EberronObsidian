...
- Spawn of Kyuss
---
# [Spawn of Kyuss](Інструменти ДМ\CLI\bestiary\undead/spawn-of-kyuss-mpmm.md)
...
"actions":
  ...
  - "desc": "A worm launches from the spawn of Kyuss at one Humanoid that the spawn\
      ...
      \ the target takes dice:2d6|noform|noparens|avg|text(7) (2d6) necrotic damage\
      \ per worm infesting it (maximum of dice:10d6|noform|noparens|avg (10d6)),\
      \ and if it drops to 0 hit points, it dies and then rises 10 minutes later as\
      \ a spawn of Kyuss. If a worm-infested target is targeted by an effect that\
      \ cures disease or removes a curse, all the worms infesting it wither away."
    "name": "Burrowing Worm"
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/undead/token/spawn-of-kyuss-mpmm.webp"
```
^statblock
