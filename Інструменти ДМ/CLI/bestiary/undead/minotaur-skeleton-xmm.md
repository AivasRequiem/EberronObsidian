...
- Minotaur Skeleton
---
# [Minotaur Skeleton](Інструменти ДМ\CLI\bestiary\undead/minotaur-skeleton-xmm.md)
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/undead/token/minotaur-skeleton-xmm.webp"
```
^statblock
