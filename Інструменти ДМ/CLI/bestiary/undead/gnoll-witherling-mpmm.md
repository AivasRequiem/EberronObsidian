...
- Gnoll Witherling
---
# [Gnoll Witherling](Інструменти ДМ\CLI\bestiary\undead/gnoll-witherling-mpmm.md)
...
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/undead/token/gnoll-witherling-mpmm.webp"
```
^statblock
