...
"traits":
  - "desc": "Any creature that starts its turn within 30 feet of the nightwalker must\
      \ succeed on a DC 21 Constitution saving throw or take dice:6d6|noform|noparens|avg|text(21)\
      \ (6d6) necrotic damage. Undead are immune to this aura."
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: dice:1d20+12|noform|noparens|text(+12) to hit,\
      \ reach 15 ft., one target. Hit: dice:5d8+6|noform|noparens|avg|text(28)\
  ...
  - "desc": "The nightwalker points at one creature it can see within 300 feet of\
      \ it. The target must succeed on a DC 21 Wisdom saving throw or take dice:6d12|noform|noparens|avg|text(39)\
      \ (6d12) necrotic damage and become [frightened](Інструменти%20ДМ/CLI/rules/conditions.md#Frightened)\
