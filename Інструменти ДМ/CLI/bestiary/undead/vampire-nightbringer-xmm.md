...
---
# [Vampire Nightbringer](Інструменти ДМ\CLI\bestiary\undead/vampire-nightbringer-xmm.md)
...
"traits":
  - "desc": "The vampire takes 10 Radiant damage if it starts its turn in sunlight.\
      \ While in sunlight, it has [Disadvantage](Інструменти%20ДМ/CLI/rules/variant-rules/disadvantage-xphb.md)\
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/undead/token/vampire-nightbringer-xmm.webp"
```
^statblock
