...
- Wight
---
# [Wight](Інструменти ДМ\CLI\bestiary\undead/wight-xmm.md)
...
"cr": "3"
"traits":
  - "desc": "While in sunlight, the wight has [Disadvantage](Інструменти%20ДМ/CLI/rules/variant-rules/disadvantage-xphb.md)\
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/undead/token/wight-xmm.webp"
```
^statblock
