...
"traits":
  ...
  - "desc": "If the demilich is destroyed, it reforms and regains all its [Hit Points](І\
      ...
      \ a [Wish](Інструменти%20ДМ/CLI/spells/wish-xphb.md) spell is cast on its remains."
...
"actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 19, each creature in a 30-foot [Emanation](І\
      ...
      \ from the demilich. *Failure:* 70 (20d6) Psychic damage. *Failure or Success:*\
...
"regional_effects":
  - "desc": "The region containing a demilich's lair is twisted by its presence, creating\
      ...
      \ than the demilich or one of its allies finishes a [Long Rest](Інструменти\
      %20ДМ/CLI/rules/variant-rules/long-rest-xphb.md) within 1 mile of the lair,\
      \ the creature must succeed on a DC 20 Constitution saving throw or have its\
      \ [Hit Point](Інструменти%20ДМ/CLI/rules/variant-rules/hit-points-xphb.md) maximum\
      \ reduced by 1d4. This reduction lasts until the creature finishes a [Long\
      \ Rest](Інструменти%20ДМ/CLI/rules/variant-rules/long-rest-xphb.md) outside\
