...
- Deep Scion
---
# [Deep Scion](Інструменти ДМ\CLI\bestiary\monstrosity/deep-scion-mpmm.md)
...
"actions":
  ...
  - "desc": "The deep scion emits a terrible scream audible within 300 feet. Creatures\
      ...
      \ or be [stunned](Інструменти%20ДМ/CLI/rules/conditions.md#Stunned) until the\
      \ end of the deep scion's next turn. In water, the psychic screech also telepathically\
...
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/monstrosity/token/deep-scion-mpmm.webp"
```
^statblock
