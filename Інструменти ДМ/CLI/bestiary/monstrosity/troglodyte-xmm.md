...
- Troglodyte
---
# [Troglodyte](Інструменти ДМ\CLI\bestiary\monstrosity/troglodyte-xmm.md)
...
"traits":
  ...
  - "desc": "While in sunlight, the troglodyte has [Disadvantage](Інструменти%20ДМ\
      /CLI/rules/variant-rules/disadvantage-xphb.md) on ability checks and attack\
      \ rolls."
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/monstrosity/token/troglodyte-xmm.webp"
```
^statblock
