...
- Primeval Owlbear
---
# [Primeval Owlbear](Інструменти ДМ\CLI\bestiary\monstrosity/primeval-owlbear-xmm.md)
...
"cr": "7"
"traits":
  - "desc": "The owlbear has [Advantage](Інструменти%20ДМ/CLI/rules/variant-rules/advantage-xphb.md)\
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/monstrosity/token/primeval-owlbear-xmm.webp"
```
^statblock
