...
- Weretiger
---
# [Weretiger](Інструменти ДМ\CLI\bestiary\monstrosity/weretiger-xmm.md)
...
"actions":
  ...
  - "desc": "Melee Attack Roll: +5, reach 5 ft. Hit: 12 (2d8 + 3) Piercing\
      ...
      \ it instead becomes a Weretiger under the DM's control and has 10 [Hit Points](І\
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/monstrosity/token/weretiger-xmm.webp"
```
^statblock
