...
---
# [Thri-kreen Gladiator](Інструменти ДМ\CLI\bestiary\monstrosity/thri-kreen-gladiator-bam.md)
...
"source":
  - "BAM"
  - "LoX"
"image": "Інструменти%20ДМ/CLI/bestiary/monstrosity/token/thri-kreen-gladiator-bam.webp"
```
^statblock