...
- Doppelganger
---
# [Doppelganger](Інструменти ДМ\CLI\bestiary\monstrosity/doppelganger-xmm.md)
...
"actions":
  ...
  - "desc": "*Wisdom Saving Throw:* DC 12, each creature in a 15-foot [Emanation](І\
      ...
      \ from the doppelganger that can see the doppelganger. *Failure:* The target\
  ...
  - "desc": "The doppelganger casts [Detect Thoughts](Інструменти%20ДМ/CLI/spells/detect-thoughts-xphb.md),\
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/monstrosity/token/doppelganger-xmm.webp"
```
^statblock
