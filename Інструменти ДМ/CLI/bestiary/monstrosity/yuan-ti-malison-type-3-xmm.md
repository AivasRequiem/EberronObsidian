...
---
# [Yuan-ti Malison (Type 3)](Інструменти ДМ\CLI\bestiary\monstrosity/yuan-ti-malison-type-3-xmm.md)
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/monstrosity/token/yuan-ti-malison-type-3-xmm.webp"
```
^statblock
