...
- Giant Axe Beak
---
# [Giant Axe Beak](Інструменти ДМ\CLI\bestiary\monstrosity/giant-axe-beak-xmm.md)
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/monstrosity/token/giant-axe-beak-xmm.webp"
```
^statblock
