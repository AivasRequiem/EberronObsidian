...
- Female Steeder
---
# [Female Steeder](Інструменти ДМ\CLI\bestiary\monstrosity/female-steeder-mpmm.md)
...
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/monstrosity/token/female-steeder-mpmm.webp"
```
^statblock
