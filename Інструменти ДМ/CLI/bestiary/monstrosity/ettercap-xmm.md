...
- Ettercap
---
# [Ettercap](Інструменти ДМ\CLI\bestiary\monstrosity/ettercap-xmm.md)
...
"bonus_actions":
  - "desc": "The ettercap pulls one creature within 30 feet of itself that is [Restrained](І\
      нструменти%20ДМ/CLI/rules/conditions.md#Restrained) by its Web Strand up to\
      \ 25 feet straight toward itself."
    "name": "Reel"
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/monstrosity/token/ettercap-xmm.webp"
```
^statblock
