...
- Sphinx of Judgment
---
# [Sphinx of Judgment](Інструменти ДМ\CLI\bestiary\monstrosity/sphinx-of-judgment-ggr.md)
...
"traits":
  ...
  - "desc": "The sphinx is immune to any effect that would sense its emotions or read\
      ...
      нструменти%20ДМ/CLI/rules/skills.md#Insight)) checks made to ascertain the sphinx's\
...
"source":
  - "GGR"
"image": "Інструменти%20ДМ/CLI/bestiary/monstrosity/token/sphinx-of-judgment-ggr.webp"
```
^statblock