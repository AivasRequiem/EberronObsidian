...
- Gnoll Flesh Gnawer
---
# [Gnoll Flesh Gnawer](Інструменти ДМ\CLI\bestiary\monstrosity/gnoll-flesh-gnawer-mpmm.md)
...
"actions":
  ...
  - "desc": "Until the end of the turn, the gnoll's speed increases by 60 feet and\
      \ it doesn't provoke [opportunity attacks](Інструменти%20ДМ/CLI/rules/actions.md#Opportunity%20Attack)."
    "name": "Sudden Rush"
"bonus_actions":
...
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/monstrosity/token/gnoll-flesh-gnawer-mpmm.webp"
```
^statblock
