...
- Ssurran Poisoner
---
# [Ssurran Poisoner](Інструменти ДМ\CLI\bestiary\monstrosity/ssurran-poisoner-bam.md)
...
"source":
  - "BAM"
  - "LoX"
"image": "Інструменти%20ДМ/CLI/bestiary/monstrosity/token/ssurran-poisoner-bam.webp"
```
^statblock