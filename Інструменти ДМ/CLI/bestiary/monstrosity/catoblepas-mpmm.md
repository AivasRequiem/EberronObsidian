...
- Catoblepas
---
# [Catoblepas](Інструменти ДМ\CLI\bestiary\monstrosity/catoblepas-mpmm.md)
...
"actions":
  ...
  - "desc": "The catoblepas targets one creature it can see within 30 feet of it.\
      \ The target must make a DC 16 Constitution saving throw, taking dice:8d8|noform|noparens|avg|text(36)\
...
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/monstrosity/token/catoblepas-mpmm.webp"
```
^statblock
