...
- Thri-kreen Mystic
---
# [Thri-kreen Mystic](Інструменти ДМ\CLI\bestiary\monstrosity/thri-kreen-mystic-bam.md)
...
"source":
  - "BAM"
  - "LoX"
"image": "Інструменти%20ДМ/CLI/bestiary/monstrosity/token/thri-kreen-mystic-bam.webp"
```
^statblock