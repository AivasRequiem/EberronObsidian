...
- Swarm of Stirges
---
# [Swarm of Stirges](Інструменти ДМ\CLI\bestiary\monstrosity/swarm-of-stirges-xmm.md)
...
"actions":
  - "desc": "Melee Attack Roll: +5, reach 5 ft. Hit: 14 (2d10 + 3) Piercing\
      ...
      \ or smaller creature in the swarm's space, the target has the [Grappled](Ін\
      струменти%20ДМ/CLI/rules/conditions.md#Grappled) condition (escape DC 13). Until\
      \ the grapple ends, the target takes 7 (2d6) Necrotic damage at the end of\
      \ each of its turns."
    "name": "Swarm of Proboscises"
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/monstrosity/token/swarm-of-stirges-xmm.webp"
```
^statblock
