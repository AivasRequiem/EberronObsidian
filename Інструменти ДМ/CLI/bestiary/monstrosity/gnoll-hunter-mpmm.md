...
- Gnoll Hunter
---
# [Gnoll Hunter](Інструменти ДМ\CLI\bestiary\monstrosity/gnoll-hunter-mpmm.md)
...
"actions":
  ...
  - "desc": "Melee  or Ranged Weapon Attack: dice:1d20+4|noform|noparens|text(+4)\
      ...
      \ + 2) piercing damage when used with two hands to make a melee attack."
    "name": "Spear"
  - "desc": "Ranged Weapon Attack: dice:1d20+4|noform|noparens|text(+4) to hit,\
      ...
      \ (1d8 + 2) piercing damage, and the target's speed is reduced by 10 feet\
...
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/monstrosity/token/gnoll-hunter-mpmm.webp"
```
^statblock
