...
- Ankheg
---
# [Ankheg](Інструменти ДМ\CLI\bestiary\monstrosity/ankheg-xmm.md)
...
"cr": "2"
"traits":
  - "desc": "The ankheg can burrow through solid rock at half its [Burrow Speed](І\
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/monstrosity/token/ankheg-xmm.webp"
```
^statblock
