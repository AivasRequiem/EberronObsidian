...
- **Infusion of Knowledge.** Whenever the sphinx or one of its allies takes a [Study](Інструменти%20ДМ/CLI/rules/actions.md#Study) action while within 1 mile of the lair, it adds `d6` to any ability check it makes for that action.  
