...
- **Darkness.** Demogorgon casts the [darkness](Інструменти%20ДМ/CLI/spells/darkness-xphb.md) spell four times, targeting different areas with the spell. Demogorgon doesn't need to concentrate on the spells, which end on initiative count 20 of the next round.  
...
- **Beguiling Realm.** Within 6 miles of the lair, all Charisma ([Persuasion](Інструменти%20ДМ/CLI/rules/skills.md#Persuasion)) and Charisma ([Performance](Інструменти%20ДМ/CLI/rules/skills.md#Performance)) checks have disadvantage, and all Charisma ([Deception](Інструменти%20ДМ/CLI/rules/skills.md#Deception)) and Charisma ([Intimidation](Інструменти%20ДМ/CLI/rules/skills.md#Intimidation)) checks have advantage.  
...
- **Venomous Beasts.** The area within 6 miles of the lair becomes overpopulated with [poisonous snakes](Інструменти%20ДМ/CLI/bestiary/beast/venomous-snake-xmm.md) and other venomous Beasts.  
