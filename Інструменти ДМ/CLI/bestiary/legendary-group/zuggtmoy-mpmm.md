...
- **Summon Fungi.** Zuggtmoy causes four [gas spores](Інструменти%20ДМ/CLI/bestiary/plant/gas-spore-fungus-xmm.md) or [violet fungi](Інструменти%20ДМ/CLI/bestiary/plant/violet-fungus-xmm.md) to appear in unoccupied spaces that she chooses within the lair. They vanish after 1 hour.  
