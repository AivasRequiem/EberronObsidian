...
As they are presented in the "Monster Manual", faerie dragons don't have access to lair actions while in their lairs. At your discretion, a [green](Інструменти%20ДМ/CLI/bestiary/dragon/faerie-dragon-adult-xmm.md) or [older faerie dragon](Інструменти%20ДМ/CLI/bestiary/dragon/faerie-dragon-adult-xmm.md) can take one of the following lair actions on initiative count 20 (losing initiative ties):
