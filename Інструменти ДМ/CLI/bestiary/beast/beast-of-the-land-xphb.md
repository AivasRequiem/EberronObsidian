...
- Beast of the Land
---
# [Beast of the Land](Інструменти ДМ\CLI\bestiary\beast/beast-of-the-land-xphb.md)
...
"actions":
  - "desc": "*Melee Attack Roll:* Bonus equals your spell attack modifier, reach 5\
      ...
      \ 1d6 damage of the same type, and the target has the [Prone](Інструменти\
      %20ДМ/CLI/rules/conditions.md#Prone) condition if it is a Large or smaller creature."
    "name": "Beast's Strike"
"source":
  - "XPHB"
"image": "Інструменти%20ДМ/CLI/bestiary/beast/token/beast-of-the-land-xphb.webp"
```
^statblock