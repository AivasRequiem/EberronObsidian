...
- Giant Insect
---
# [Giant Insect](Інструменти ДМ\CLI\bestiary\beast/giant-insect-xphb.md)
...
"bonus_actions":
  - "desc": "Constitution Saving Throw: Your spell save DC, one creature the insect\
      ...
      ти%20ДМ/CLI/rules/conditions.md#Poisoned) condition until the start of the insect's\
      \ next turn."
    "name": "Venomous Spew (Centipede Only)"
"source":
  - "XPHB"
"image": "Інструменти%20ДМ/CLI/bestiary/beast/token/giant-insect-xphb.webp"
```
^statblock