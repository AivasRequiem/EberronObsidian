...
- Giant Rat
---
# [Giant Rat](Інструменти ДМ\CLI\bestiary\beast/giant-rat-xmm.md)
...
"cr": "1/8"
"traits":
  - "desc": "The rat has [Advantage](Інструменти%20ДМ/CLI/rules/variant-rules/advantage-xphb.md)\
      \ on an attack roll against a creature if at least one of the rat's allies is\
      \ within 5 feet of the creature and the ally doesn't have the [Incapacitated](І\
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/beast/token/giant-rat-xmm.webp"
```
^statblock
