...
- Giant Fire Beetle
---
# [Giant Fire Beetle](Інструменти ДМ\CLI\bestiary\beast/giant-fire-beetle-xmm.md)
...
"cr": "0"
"traits":
  - "desc": "The beetle sheds [Bright Light](Інструменти%20ДМ/CLI/rules/variant-rules/bright-light-xphb.md)\
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/beast/token/giant-fire-beetle-xmm.webp"
```
^statblock
