...
- Frog
---
# [Frog](Інструменти ДМ\CLI\bestiary\beast/frog-xmm.md)
...
"traits":
  ...
  - "desc": "The frog's [Long Jump](Інструменти%20ДМ/CLI/rules/variant-rules/long-jump-xphb.md)\
      \ is up to 10 feet and its [High Jump](Інструменти%20ДМ/CLI/rules/variant-rules/high-jump-xphb.md)\
...
"source":
  - "XMM"
  - "XPHB"
"image": "Інструменти%20ДМ/CLI/bestiary/beast/token/frog-xmm.webp"
```
^statblock
