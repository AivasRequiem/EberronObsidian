...
- Baboon
---
# [Baboon](Інструменти ДМ\CLI\bestiary\beast/baboon-xmm.md)
...
"cr": "0"
"traits":
  - "desc": "The baboon has [Advantage](Інструменти%20ДМ/CLI/rules/variant-rules/advantage-xphb.md)\
...
"actions":
  - "desc": "Melee Attack Roll: dice:1d20+1|noform|noparens|text(+1), reach 5\
      \ ft. Hit: dice:1d4-1|noform|noparens|avg|text(1) (1d4 - 1) Piercing damage."
    "name": "Bite"
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/beast/token/baboon-xmm.webp"
```
^statblock
