...
- Lion
---
# [Lion](Інструменти ДМ\CLI\bestiary\beast/lion-xmm.md)
...
"cr": "1"
"traits":
  - "desc": "The lion has [Advantage](Інструменти%20ДМ/CLI/rules/variant-rules/advantage-xphb.md)\
    ...
    "name": "Pack Tactics"
  - "desc": "With a 10-foot running start, the lion can [Long Jump](Інструменти%20Д\
...
"source":
  - "XMM"
  - "XPHB"
"image": "Інструменти%20ДМ/CLI/bestiary/beast/token/lion-xmm.webp"
```
^statblock
