...
- Velociraptor
---
# [Velociraptor](Інструменти ДМ\CLI\bestiary\beast/velociraptor-mpmm.md)
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: dice:1d20+4|noform|noparens|text(+4) to hit,\
      \ reach 5 ft., one creature. Hit: dice:1d6+2|noform|noparens|avg|text(5)\
...
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/beast/token/velociraptor-mpmm.webp"
```
^statblock
