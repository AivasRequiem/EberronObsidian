...
- Constrictor Snake
---
# [Constrictor Snake](Інструменти ДМ\CLI\bestiary\beast/constrictor-snake-xmm.md)
...
"source":
  - "XMM"
  - "XPHB"
"image": "Інструменти%20ДМ/CLI/bestiary/beast/token/constrictor-snake-xmm.webp"
```
^statblock
