...
- Octopus
---
# [Octopus](Інструменти ДМ\CLI\bestiary\beast/octopus-xmm.md)
...
"reactions":
  - "desc": "Trigger: A creature ends its turn within 5 feet of the octopus while\
      \ underwater. _Response:_ The octopus releases ink that fills a 5-foot [Cube](І\
      нструменти%20ДМ/CLI/rules/variant-rules/cube-area-of-effect-xphb.md) centered\
      \ on itself, and the octopus moves up to its [Swim Speed](Інструменти%20ДМ/CLI/rules/variant-rules/swim-speed-xphb.md).\
      \ The [Cube](Інструменти%20ДМ/CLI/rules/variant-rules/cube-area-of-effect-xphb.md)\
      \ is [Heavily Obscured](Інструменти%20ДМ/CLI/rules/variant-rules/heavily-obscured-xphb.md)\
      \ for 1 minute or until a strong current or similar effect disperses the ink."
    "name": "Ink Cloud (1/Day)"
"source":
  - "XMM"
  - "XPHB"
"image": "Інструменти%20ДМ/CLI/bestiary/beast/token/octopus-xmm.webp"
```
^statblock
