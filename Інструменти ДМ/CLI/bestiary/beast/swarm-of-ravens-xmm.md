...
- Swarm of Ravens
---
# [Swarm of Ravens](Інструменти ДМ\CLI\bestiary\beast/swarm-of-ravens-xmm.md)
...
"actions":
  - "desc": "Melee Attack Roll: dice:1d20+4|noform|noparens|text(+4), reach 5\
      ...
      \ or dice:1d4|noform|noparens|avg|text(2) (d4) Piercing damage if the swarm\
      \ is [Bloodied](Інструменти%20ДМ/CLI/rules/conditions.md#Bloodied)."
    "name": "Beaks"
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/beast/token/swarm-of-ravens-xmm.webp"
```
^statblock
