...
"actions":
  ...
  - "desc": "Ranged Weapon Attack: dice:1d20+4|noform|noparens|text(+4) to hit,\
    ...
    "name": "Sling"
  - "desc": "The kobold uses one of the following options (choose one or roll a dice:d8|noform|noparens|avg\
      \ (d8)); the kobold can use each one no more than once per day:\n\n- 1 Acid.\
      \ The kobold hurls a [flask of acid](Інструменти%20ДМ/CLI/items/acid-xphb.md).\
      \ Ranged Weapon Attack: dice:1d20+4|noform|noparens|text(+4) to hit, range\
      \ 5/20 ft., one target. Hit: dice:2d6|noform|noparens|avg|text(7) (2d6)\
      ...
      \ Attack: dice:1d20+4|noform|noparens|text(+4) to hit, range 5/20 ft., one\
      \ target. Hit: dice:1d4|noform|noparens|avg|text(2) (d4) fire damage at\
      \ the start of each of the target's turns. The target can end this damage by\
      ...
      \ it breaks open on impact. Ranged Weapon Attack: dice:1d20+4|noform|noparens|text(+4)\
      \ to hit, range 5/20 ft., one target. Hit: dice:1d10|noform|noparens|avg|text(5)\
      \ (d10) acid damage, and the target is covered in slime until a creature uses\
      \ its action to scrape or wash the slime off. A target covered in the slime\
      \ takes dice:1d10|noform|noparens|avg|text(5) (d10) acid damage at the start\
      ...
      \ A [swarm of rot grubs](Інструменти%20ДМ/CLI/bestiary/beast/swarm-of-rot-grubs-mpmm.md)\
      ...
      \ the end of a 5-foot-long pole. Melee Weapon Attack: dice:1d20+4|noform|noparens|text(+4)\
      \ to hit, reach 5 ft., one target. Hit: 1 piercing damage, and the target\
      \ must make a DC 9 Constitution saving throw, taking dice:1d8|noform|noparens|avg|text(4)\
      \ (d8) poison damage on a failed save, or half as much damage on a successful\
      ...
      \ target must succeed on a DC 9 Constitution saving throw, or it retches and\
      ...
      \ (wasps)](Інструменти%20ДМ/CLI/bestiary/beast/swarm-of-insects-xmm.md) with\
      \ 11 hit points emerges from the bag and rolls initiative. At the end of each\
      \ of the swarm's turns, there's a 50 percent chance that the swarm disperses.\
      \  "
