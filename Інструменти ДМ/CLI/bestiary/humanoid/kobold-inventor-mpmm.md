...
"actions":
  ...
  - "desc": "The kobold uses one of the following options (choose one or roll a d8);\
      ...
      \ Attack:* +4 to hit, range 5/20 ft., one target. *Hit:* 2 (1d4) fire damage\
      ...
      \ ft., one target. *Hit:* 5 (1d10) acid damage, and the target is covered\
      \ in slime until a creature uses its action to scrape or wash the slime off.\
      \ A target covered in the slime takes 5 (1d10) acid damage at the start of\
