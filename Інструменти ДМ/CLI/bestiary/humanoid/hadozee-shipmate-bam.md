...
- Hadozee Shipmate
---
# [Hadozee Shipmate](Інструменти ДМ\CLI\bestiary\humanoid/hadozee-shipmate-bam.md)
...
"source":
  - "BAM"
  - "LoX"
"image": "Інструменти%20ДМ/CLI/bestiary/humanoid/token/hadozee-shipmate-bam.webp"
```
^statblock