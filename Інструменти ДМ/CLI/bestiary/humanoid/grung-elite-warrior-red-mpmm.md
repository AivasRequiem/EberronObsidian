...
---
# [Grung Elite Warrior (Red)](Інструменти ДМ\CLI\bestiary\humanoid/grung-elite-warrior-red-mpmm.md)
...
"traits":
  ...
  - "desc": "A creature [poisoned](Інструменти%20ДМ/CLI/rules/conditions.md#Poisoned)\
      ...
      %20ДМ/CLI/rules/conditions.md#Poisoned) creature must use its action to eat\
      \ if food is within reach."
    "name": "Poisonous Skin"
