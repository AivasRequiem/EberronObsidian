...
"traits":
  - "desc": "The blastseeker's innate spellcasting ability is Intelligence (spell\
      \ save DC 16, dice:1d20+8|noform|noparens|text(+8) to hit with spell attacks).\
      ...
      \ each: [banishment](Інструменти%20ДМ/CLI/spells/banishment-xphb.md), [cone\
      \ of cold](Інструменти%20ДМ/CLI/spells/cone-of-cold-xphb.md), [dimension door](І\
      нструменти%20ДМ/CLI/spells/dimension-door-xphb.md), [fireball](Інструменти%20Д\
      М/CLI/spells/fireball-xphb.md), [ice storm](Інструменти%20ДМ/CLI/spells/ice-storm-xphb.md)"
  ...
  - "desc": "The blastseeker can create an additional effect immediately after casting\
      ...
      \ within 30 feet of it. 4-6. The blastseeker and each creature within 10 feet\
      \ of it must succeed on a DC 16 Constitution saving throw or take dice:2d10|noform|noparens|avg|text(11)\
      \ (2d10) thunder damage."
