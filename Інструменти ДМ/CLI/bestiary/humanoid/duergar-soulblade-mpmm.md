...
- Duergar Soulblade
---
# [Duergar Soulblade](Інструменти ДМ\CLI\bestiary\humanoid/duergar-soulblade-mpmm.md)
...
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/humanoid/token/duergar-soulblade-mpmm.webp"
```
^statblock
