...
- Giff Shock Trooper
---
# [Giff Shock Trooper](Інструменти ДМ\CLI\bestiary\humanoid/giff-shock-trooper-bam.md)
...
"source":
  - "BAM"
  - "LoX"
"image": "Інструменти%20ДМ/CLI/bestiary/humanoid/token/giff-shock-trooper-bam.webp"
```
^statblock