...
- Duergar Stone Guard
---
# [Duergar Stone Guard](Інструменти ДМ\CLI\bestiary\humanoid/duergar-stone-guard-mpmm.md)
...
"traits":
  ...
  - "desc": "The duergar has advantage on attack rolls and Dexterity saving throws\
      \ while standing within 5 feet of an ally wielding a [shield](Інструменти%20Д\
      М/CLI/items/shield-xphb.md)."
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: dice:1d20+6|noform|noparens|text(+6) to hit,\
      ...
      \ + 4) piercing damage, or dice:2d6+4|noform|noparens|avg|text(11) (2d6\
...
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/humanoid/token/duergar-stone-guard-mpmm.webp"
```
^statblock
