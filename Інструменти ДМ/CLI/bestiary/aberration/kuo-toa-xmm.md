...
- Kuo-toa
---
# [Kuo-toa](Інструменти ДМ\CLI\bestiary\aberration/kuo-toa-xmm.md)
...
"actions":
  ...
  - "desc": "Dexterity Saving Throw: DC 10, one Large or smaller creature the kuo-toa\
      ...
      \ to make a DC 10 Strength ([Athletics](Інструменти%20ДМ/CLI/rules/skills.md#Athletics))\
...
"reactions":
  - "desc": "Trigger: A creature misses the kuo-toa with a melee attack roll using\
      ...
      \ to make a DC 11 Strength ([Athletics](Інструменти%20ДМ/CLI/rules/skills.md#Athletics))\
      \ check, freeing the weapon on a success."
    "name": "Sticky Shield"
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/aberration/token/kuo-toa-xmm.webp"
```
^statblock
