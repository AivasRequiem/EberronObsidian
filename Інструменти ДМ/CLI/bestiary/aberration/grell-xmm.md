...
- Grell
---
# [Grell](Інструменти ДМ\CLI\bestiary\aberration/grell-xmm.md)
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +4, reach 10 ft. *Hit:* 7 (1d10 + 2) Piercing\
      ...
      М/CLI/rules/conditions.md#Poisoned), the target has the [Paralyzed](Інструме\
      нти%20ДМ/CLI/rules/conditions.md#Paralyzed) condition."
    "name": "Paralyzing Tentacles"
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/aberration/token/grell-xmm.webp"
```
^statblock
