...
"senses": "[blindsight](Інструменти%20ДМ/CLI/rules/senses.md#Blindsight) 500 ft. (blind\
...
"lair_actions":
  - "desc": "On initiative count 20 (losing initiative ties), a balhannoth can take\
      ...
      \ becomes [invisible](Інструменти%20ДМ/CLI/rules/conditions.md#Invisible) to\
      \ that creature for 1 minute. This effect ends if the balhannoth attacks the\
      ...
      \ the balhannoth has sensed (see Regional Effects below). The transformation\
