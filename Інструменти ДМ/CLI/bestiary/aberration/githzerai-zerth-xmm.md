...
- Githzerai Zerth
---
# [Githzerai Zerth](Інструменти ДМ\CLI\bestiary\aberration/githzerai-zerth-xmm.md)
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/aberration/token/githzerai-zerth-xmm.webp"
```
^statblock
