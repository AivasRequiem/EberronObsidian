...
- Kuo-toa Monitor
---
# [Kuo-toa Monitor](Інструменти ДМ\CLI\bestiary\aberration/kuo-toa-monitor-xmm.md)
...
"actions":
  ...
  - "desc": "Melee Attack Roll: +5, reach 10 ft. Hit: 6 (1d6 + 3) Slashing\
      ...
      \ Attacks until the start of the kuo-toa's next turn."
    "name": "Bone Whip"
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/aberration/token/kuo-toa-monitor-xmm.webp"
```
^statblock
