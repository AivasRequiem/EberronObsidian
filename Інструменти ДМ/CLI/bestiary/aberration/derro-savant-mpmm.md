...
- Derro Savant
---
# [Derro Savant](Інструменти ДМ\CLI\bestiary\aberration/derro-savant-mpmm.md)
...
"actions":
  ...
  - "desc": "The derro launches a brilliant beam of magical energy in a 5-foot-wide\
      ...
      \ saving throw, taking dice:6d6|noform|noparens|avg|text(21) (6d6) radiant\
...
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/aberration/token/derro-savant-mpmm.webp"
```
^statblock
