...
- Otherworldly Steed
---
# [Otherworldly Steed](Інструменти ДМ\CLI\bestiary\miscellaneous/otherworldly-steed-xphb.md)
...
"actions":
  - "desc": "Melee Attack Roll: Bonus equals your spell attack modifier, reach 5\
      \ ft. Hit: d8 + the spell's level of Radiant (Celestial), Psychic (Fey),\
...
"source":
  - "XPHB"
"image": "Інструменти%20ДМ/CLI/bestiary/miscellaneous/token/otherworldly-steed-xphb.webp"
```
^statblock