...
- Quasit
---
# [Quasit](Інструменти ДМ\CLI\bestiary\fiend/quasit-xmm.md)
...
"cr": "1"
"traits":
  - "desc": "The quasit has [Advantage](Інструменти%20ДМ/CLI/rules/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "Wisdom Saving Throw: DC 10, one creature within 20 feet. Failure:\
    ...
    "name": "Scare (1/Day)"
  - "desc": "The quasit shape-shifts to resemble a bat ([Speed](Інструменти%20ДМ/CLI/rules/variant-rules/speed-xphb.md)\
      ...
      \ same in each form, except for its [Speed](Інструменти%20ДМ/CLI/rules/variant-rules/speed-xphb.md).\
      \ Any equipment it is wearing or carrying isn't transformed."
    "name": "Shape-Shift"
  - "desc": "The quasit casts [Invisibility](Інструменти%20ДМ/CLI/spells/invisibility-xphb.md)\
...
"source":
  - "XMM"
  - "XPHB"
"image": "Інструменти%20ДМ/CLI/bestiary/fiend/token/quasit-xmm.webp"
```
^statblock
