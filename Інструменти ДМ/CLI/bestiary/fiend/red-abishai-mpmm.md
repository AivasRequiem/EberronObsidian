...
- Red Abishai
---
# [Red Abishai](Інструменти ДМ\CLI\bestiary\fiend/red-abishai-mpmm.md)
...
"actions":
  ...
  - "desc": "Each creature of the abishai's choice that is within 120 feet and aware\
      ...
      нструменти%20ДМ/CLI/rules/conditions.md#Frightened) of it for 1 minute. A creature\
      \ can repeat the saving throw at the end of each of its turns, ending the effect\
      \ on itself on a success. If a creature's saving throw is successful or the\
      \ effect ends for it, the creature is immune to the abishai's Frightful Presence\
  ...
  - "desc": "The abishai chooses up to four other creatures within 60 feet of it that\
      ...
      \ makes attack rolls with advantage and can't be [frightened](Інструменти%20Д\
      М/CLI/rules/conditions.md#Frightened)."
  ...
  - "desc": "The abishai targets one Dragon it can see within 120 feet of it. The\
      ...
      \ is [charmed](Інструменти%20ДМ/CLI/rules/conditions.md#Charmed) by the abishai\
      \ for 1 hour. While [charmed](Інструменти%20ДМ/CLI/rules/conditions.md#Charmed)\
...
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/fiend/token/red-abishai-mpmm.webp"
```
^statblock
