...
- Nycaloth
---
# [Nycaloth](Інструменти ДМ\CLI\bestiary\fiend/nycaloth-xmm.md)
...
"traits":
  ...
  - "desc": "The nycaloth has [Advantage](Інструменти%20ДМ/CLI/rules/variant-rules/advantage-xphb.md)\
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/fiend/token/nycaloth-xmm.webp"
```
^statblock
