...
- Flind
---
# [Flind](Інструменти ДМ\CLI\bestiary\fiend/flind-mpmm.md)
...
"cr": "9"
"traits":
  - "desc": "If the flind isn't [incapacitated](Інструменти%20ДМ/CLI/rules/conditions.md#Incapacitated),\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +9 to hit, reach 10 ft., one target. *Hit:*\
      ...
      \ Constitution saving throw or be [paralyzed](Інструменти%20ДМ/CLI/rules/conditions.md#Paralyzed)\
...
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/fiend/token/flind-mpmm.webp"
```
^statblock
