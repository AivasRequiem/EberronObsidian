...
- Merregon
---
# [Merregon](Інструменти ДМ\CLI\bestiary\fiend/merregon-mpmm.md)
...
"cr": "4"
"traits":
  - "desc": "Magical darkness doesn't impede the merregon's [darkvision](Інструмен\
      ти%20ДМ/CLI/rules/senses.md#Darkvision)."
    "name": "Devil's Sight"
...
"actions":
  ...
  - "desc": "Ranged Weapon Attack: dice:1d20+4|noform|noparens|text(+4) to hit,\
      \ range 100/400 ft., one target. Hit: dice:1d10+2|noform|noparens|avg|text(7)\
...
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/fiend/token/merregon-mpmm.webp"
```
^statblock