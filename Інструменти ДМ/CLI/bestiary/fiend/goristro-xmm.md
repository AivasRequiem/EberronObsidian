...
- Goristro
---
# [Goristro](Інструменти ДМ\CLI\bestiary\fiend/goristro-xmm.md)
...
"traits":
  ...
  - "desc": "The goristro has [Advantage](Інструменти%20ДМ/CLI/rules/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "Melee Attack Roll: dice:1d20+13|noform|noparens|text(+13), reach\
    ...
    "name": "Slam"
"bonus_actions":
  - "desc": "The goristro moves up to half its [Speed](Інструменти%20ДМ/CLI/rules/variant-rules/speed-xphb.md)\
      \ straight toward an enemy it can see."
    "name": "Charge"
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/fiend/token/goristro-xmm.webp"
```
^statblock
