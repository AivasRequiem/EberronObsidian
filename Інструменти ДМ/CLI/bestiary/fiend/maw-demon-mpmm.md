...
- Maw Demon
---
# [Maw Demon](Інструменти ДМ\CLI\bestiary\fiend/maw-demon-mpmm.md)
...
"actions":
  ...
  - "desc": "The demon vomits in a 15-foot cube. Each creature in that area must succeed\
      \ on a DC 11 Dexterity saving throw or take dice:2d10|noform|noparens|avg|text(11)\
      \ (2d10) acid damage and fall [prone](Інструменти%20ДМ/CLI/rules/conditions.md#Prone)\
      \ in the spew."
    "name": "Disgorge (Recharge 6)"
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/fiend/token/maw-demon-mpmm.webp"
```
^statblock
