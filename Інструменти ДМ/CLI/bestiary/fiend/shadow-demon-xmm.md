...
- Shadow Demon
---
# [Shadow Demon](Інструменти ДМ\CLI\bestiary\fiend/shadow-demon-xmm.md)
...
"bonus_actions":
  - "desc": "While in [Dim Light](Інструменти%20ДМ/CLI/rules/variant-rules/dim-light-xphb.md)\
      ...
      \ the demon takes the Hide action."
    "name": "Shadow Stealth"
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/fiend/token/shadow-demon-xmm.webp"
```
^statblock
