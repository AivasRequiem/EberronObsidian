...
"actions":
  ...
  - "desc": "Melee Weapon Attack: dice:1d20+9|noform|noparens|text(+9) to hit,\
      \ reach 5 ft., one target. Hit: dice:2d10+5|noform|noparens|avg|text(16)\
      \ (2d10 + 5) force damage plus dice:2d10|noform|noparens|avg|text(9) (2d10)\
      \ psychic damage."
    "name": "Bite"
  - "desc": "Melee Weapon Attack: dice:1d20+9|noform|noparens|text(+9) to hit,\
      \ reach 5 ft., one target.  Hit: dice:2d8+5|noform|noparens|avg|text(14)\
      \ (2d8 + 5) force damage plus dice:2d10|noform|noparens|avg|text(9) (2d10)\
      \ psychic damage."
    "name": "Claw"
  - "desc": "The hydroloth targets one creature it can see within 60 feet of it. The\
      \ target takes dice:4d6|noform|noparens|avg|text(14) (4d6) psychic damage,\
      \ and it must make a DC 16 Intelligence saving throw. On a successful save,\
      \ the target becomes immune to this hydroloth's Steal Memory for 24 hours. On\
      \ a failed save, the target loses all proficiencies; it can't cast spells; it\
      \ can't understand language; and if its Intelligence and Charisma scores are\
      \ higher than 5, they become 5. Each time the target finishes a long rest, it\
      \ can repeat the saving throw, ending the effect on itself on a success. A [greater\
      \ restoration](Інструменти%20ДМ/CLI/spells/greater-restoration-xphb.md) or [remove\
      \ curse](Інструменти%20ДМ/CLI/spells/remove-curse-xphb.md) spell cast on the\
