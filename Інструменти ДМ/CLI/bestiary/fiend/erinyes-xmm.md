...
- Erinyes
---
# [Erinyes](Інструменти ДМ\CLI\bestiary\fiend/erinyes-xmm.md)
...
"traits":
  ...
  - "desc": "The erinyes has [Advantage](Інструменти%20ДМ/CLI/rules/variant-rules/advantage-xphb.md)\
      \ on saving throws against spells and other magical effects."
    "name": "Magic Resistance"
  - "desc": "The erinyes has a magic rope. While bearing it, the erinyes can use the\
      \ Entangling Rope action. The rope has AC 20, HP 90, and [Immunity](Інструме\
      нти%20ДМ/CLI/rules/variant-rules/immunity-xphb.md) to Poison and Psychic damage.\
      \ The rope turns to dust if reduced to 0 [Hit Points](Інструменти%20ДМ/CLI/rules/variant-rules/hit-points-xphb.md),\
      ...
      \ when finishing a [Short](Інструменти%20ДМ/CLI/rules/variant-rules/short-rest-xphb.md)\
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/fiend/token/erinyes-xmm.webp"
```
^statblock
