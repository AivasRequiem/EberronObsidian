...
- Big Momma
---
# [Big Momma](Інструменти ДМ\CLI\bestiary\npc/big-momma-lox.md)
...
"bonus_actions":
  - "desc": "Big Momma's eye emits an [invisible](Інструменти%20ДМ/CLI/rules/conditions.md#Invisible),\
      ...
      нструменти%20ДМ/CLI/rules/conditions.md#Frightened) of Big Momma until the start\
      \ of Big Momma's next turn."
    "name": "Ray of Fear (Recharge 4-6)"
"source":
  - "LoX"
"image": "Інструменти%20ДМ/CLI/bestiary/npc/token/big-momma-lox.webp"
```
^statblock