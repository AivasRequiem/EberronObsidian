...
- Princess Xedalli
---
# [Princess Xedalli](Інструменти ДМ\CLI\bestiary\npc/princess-xedalli-lox.md)
...
"cr": "8"
"traits":
  - "desc": "Xedalli has advantage on saving throws it makes to avoid or end the [charmed](І\
      нструменти%20ДМ/CLI/rules/conditions.md#Charmed) condition on itself, and magic\
      \ can't put it to sleep."
    "name": "Fey Ancestry"
  - "desc": "Xedalli wears a suit of [elven chain](Інструменти%20ДМ/CLI/items/elven-chain-xdmg.md)."
...
"source":
  - "LoX"
"image": "Інструменти%20ДМ/CLI/bestiary/npc/token/princess-xedalli-lox.webp"
```
^statblock