...
- Niv-Mizzet
---
# [Niv-Mizzet](Інструменти ДМ\CLI\bestiary\npc/niv-mizzet-ggr.md)
...
"traits":
  ...
  - "desc": "Niv-Mizzet can maintain [concentration](Інструменти%20ДМ/CLI/rules/conditions.md#Concentration)\
      \ on two different spells at the same time. In addition, he has advantage on\
      \ saving throws to maintain [concentration](Інструменти%20ДМ/CLI/rules/conditions.md#Concentration)\
      \ on spells."
...
"source":
  - "GGR"
"image": "Інструменти%20ДМ/CLI/bestiary/npc/token/niv-mizzet-ggr.webp"
```
^statblock