...
- Garra
---
# [Garra](Інструменти ДМ\CLI\bestiary\npc/garra-erlw.md)
...
"actions":
  - "desc": "Melee Weapon Attack: dice:1d20+5|noform|noparens|text(+5) to hit,\
      ...
      \ (2d8 + 3) slashing damage, or dice:2d10+3|noform|noparens|avg|text(14)\
      \ (2d10 + 3) slashing damage if used with two hands."
    "name": "Battleaxe"
  - "desc": "Melee  or Ranged Weapon Attack: dice:1d20+5|noform|noparens|text(+5)\
      \ to hit, reach 5 ft. or range 30/120 ft., one target. Hit: dice:2d6+3|noform|noparens|avg|text(10)\
      \ (2d6 + 3) piercing damage."
    "name": "Javelin"
"source":
  - "ERLW"
"image": "Інструменти%20ДМ/CLI/bestiary/npc/token/garra-erlw.webp"
```
^statblock