...
- Prince Xeleth
---
# [Prince Xeleth](Інструменти ДМ\CLI\bestiary\npc/prince-xeleth-lox.md)
...
"cr": "8"
"traits":
  - "desc": "Xeleth has advantage on saving throws it makes to avoid or end the [charmed](І\
      нструменти%20ДМ/CLI/rules/conditions.md#Charmed) condition on itself, and magic\
      \ can't put it to sleep."
    "name": "Fey Ancestry"
  - "desc": "Xeleth wears a suit of [elven chain](Інструменти%20ДМ/CLI/items/elven-chain-xdmg.md)."
...
"source":
  - "LoX"
"image": "Інструменти%20ДМ/CLI/bestiary/npc/token/prince-xeleth-lox.webp"
```
^statblock