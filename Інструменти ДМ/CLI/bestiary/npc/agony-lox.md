...
- Agony
---
# [Agony](Інструменти ДМ\CLI\bestiary\npc/agony-lox.md)
...
"actions":
  ...
  - "desc": "Each non-undead creature within 60 feet of Agony that can see it must\
      \ succeed on a DC 13 Wisdom saving throw or be [frightened](Інструменти%20ДМ\
      /CLI/rules/conditions.md#Frightened) for 1 minute. If the save fails by 5 or\
      \ more, the target also ages 1d4 × 10 years. A [frightened](Інструменти%20Д\
      М/CLI/rules/conditions.md#Frightened) target can repeat the saving throw at\
      \ the end of each of its turns, ending the [frightened](Інструменти%20ДМ/CLI/rules/conditions.md#Frightened)\
      ...
      \ restoration](Інструменти%20ДМ/CLI/spells/greater-restoration-xphb.md) spell,\
  ...
  - "desc": "One humanoid that Agony can see within 5 feet of it must succeed on a\
      ...
      \ and the target is [incapacitated](Інструменти%20ДМ/CLI/rules/conditions.md#Incapacitated)\
      ...
      \ Intelligence, Wisdom, Charisma, and immunity to being [charmed](Інструмент\
      и%20ДМ/CLI/rules/conditions.md#Charmed) and [frightened](Інструменти%20ДМ/CLI/rules/conditions.md#Frightened).\
      ...
      \ or Agony is turned or forced out by an effect like the [dispel evil and good](І\
      нструменти%20ДМ/CLI/spells/dispel-evil-and-good-xphb.md) spell. When the possession\
      \ ends, Agony reappears in an unoccupied space within 5 feet of the body. The\
      \ target is immune to this ghost's Possession for 24 hours after succeeding\
      \ on the saving throw or after the possession ends."
    "name": "Possession (Recharge 6)"
"source":
  - "LoX"
"image": "Інструменти%20ДМ/CLI/bestiary/npc/token/agony-lox.webp"
```
^statblock