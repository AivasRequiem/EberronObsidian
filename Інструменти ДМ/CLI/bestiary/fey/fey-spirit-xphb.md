...
- Fey Spirit
---
# [Fey Spirit](Інструменти ДМ\CLI\bestiary\fey/fey-spirit-xphb.md)
...
"bonus_actions":
  - "desc": "The spirit magically teleports up to 30 feet to an unoccupied space it\
      ...
      \ of itself. *Failure:* The target is [Charmed](Інструменти%20ДМ/CLI/rules/conditions.md#Charmed)\
...
"source":
  - "XPHB"
"image": "Інструменти%20ДМ/CLI/bestiary/fey/token/fey-spirit-xphb.webp"
```
^statblock