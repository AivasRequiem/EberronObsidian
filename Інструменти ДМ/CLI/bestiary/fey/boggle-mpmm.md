...
- Boggle
---
# [Boggle](Інструменти ДМ\CLI\bestiary\fey/boggle-mpmm.md)
...
"bonus_actions":
  - "desc": "The boggle excretes nonflammable oil from its pores, giving itself one\
      ...
      \  "
    "name": "Boggle Oil"
  - "desc": "The boggle creates an [invisible](Інструменти%20ДМ/CLI/rules/conditions.md#Invisible)\
...
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/fey/token/boggle-mpmm.webp"
```
^statblock
