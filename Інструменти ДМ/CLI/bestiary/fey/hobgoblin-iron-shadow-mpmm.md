...
---
# [Hobgoblin Iron Shadow](Інструменти ДМ\CLI\bestiary\fey/hobgoblin-iron-shadow-mpmm.md)
...
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/fey/token/hobgoblin-iron-shadow-mpmm.webp"
```
^statblock
