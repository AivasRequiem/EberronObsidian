...
- Fey Spirit (Mirthful)
---
# [Fey Spirit (Mirthful)](Інструменти ДМ\CLI\bestiary\fey/fey-spirit-mirthful-xphb.md)
...
"bonus_actions":
  - "desc": "The spirit magically teleports up to 30 feet to an unoccupied space it\
      ...
      \ the spirit can see within 10 feet of itself. Failure: The target is [Charmed](І\
      нструменти%20ДМ/CLI/rules/conditions.md#Charmed) by you and the spirit for 1\
      \ minute or until the target takes any damage."
    "name": "Fey Step"
"source":
  - "XPHB"
```
