...
- Hobgoblin Warrior
---
# [Hobgoblin Warrior](Інструменти ДМ\CLI\bestiary\fey/hobgoblin-warrior-xmm.md)
...
"cr": "1/2"
"traits":
  - "desc": "The hobgoblin has [Advantage](Інструменти%20ДМ/CLI/rules/variant-rules/advantage-xphb.md)\
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/fey/token/hobgoblin-warrior-xmm.webp"
```
^statblock
