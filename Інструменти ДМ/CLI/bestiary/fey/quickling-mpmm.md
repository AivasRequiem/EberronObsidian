...
- Quickling
---
# [Quickling](Інструменти ДМ\CLI\bestiary\fey/quickling-mpmm.md)
...
"cr": "1"
"traits":
  - "desc": "Attack rolls against the quickling have disadvantage unless it is [incapacitated](І\
      нструменти%20ДМ/CLI/rules/conditions.md#Incapacitated) or its speed is 0."
  ...
  - "desc": "If the quickling is subjected to an effect that allows it to make a Dexterity\
      ...
      \ on the saving throw and only half damage if it fails, provided it isn't [incapacitated](І\
...
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/fey/token/quickling-mpmm.webp"
```
^statblock
