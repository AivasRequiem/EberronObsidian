...
"actions":
  ...
  - "desc": "Melee Weapon Attack: dice:1d20+8|noform|noparens|text(+8) to hit,\
      \ reach 10 ft., one target. Hit: dice:6d12+4|noform|noparens|avg|text(43)\
      \ (6d12 + 4) bludgeoning damage."
    "name": "Slam"
  - "desc": "Ranged Weapon Attack: dice:1d20+8|noform|noparens|text(+8) to hit,\
      \ range 60 ft./240 ft., one target. Hit: dice:6d10+4|noform|noparens|avg|text(37)\
      \ (6d10 + 4) bludgeoning damage."
    "name": "Rock"
"source":
  - "MPMM"
