...
---
# [Animated Flying Sword](Інструменти ДМ\CLI\bestiary\construct/animated-flying-sword-xmm.md)
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/construct/token/animated-flying-sword-xmm.webp"
```
^statblock
