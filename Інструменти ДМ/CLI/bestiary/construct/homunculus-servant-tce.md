...
- Homunculus Servant
---
# [Homunculus Servant](Інструменти ДМ\CLI\bestiary\construct/homunculus-servant-tce.md)
...
"source":
  - "TCE"
  - "ERLW"
"image": "Інструменти%20ДМ/CLI/bestiary/construct/token/homunculus-servant-tce.webp"
```
^statblock