...
---
# [Clockwork Bronze Scout](Інструменти ДМ\CLI\bestiary\construct/clockwork-bronze-scout-mpmm.md)
...
"cr": "1"
"traits":
  - "desc": "The clockwork doesn't provoke [opportunity attacks](Інструменти%20ДМ\
      /CLI/rules/actions.md#Opportunity%20Attack) when it burrows."
    "name": "Earth Armor"
...
"actions":
  - "desc": "Melee Weapon Attack: dice:1d20+5|noform|noparens|text(+5) to hit,\
      ...
      \ + 3) piercing damage plus dice:1d6|noform|noparens|avg|text(3) (d6) lightning\
      \ damage."
    "name": "Bite"
  - "desc": "Each creature in contact with the ground within 15 feet of the clockwork\
      \ must make a DC 13 Dexterity saving throw, taking dice:4d6|noform|noparens|avg|text(14)\
      \ (4d6) lightning damage on a failed save, or half as much damage on a successful\
      \ one."
    "name": "Lightning Flare (Recharges after a Short or Long Rest)"
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/construct/token/clockwork-bronze-scout-mpmm.webp"
```
^statblock
