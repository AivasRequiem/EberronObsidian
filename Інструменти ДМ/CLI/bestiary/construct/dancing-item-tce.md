...
- Dancing Item
---
# [Dancing Item](Інструменти ДМ\CLI\bestiary\construct/dancing-item-tce.md)
...
"traits":
  ...
  - "desc": "When any creature starts its turn within 10 feet of the item, the item\
      ...
      \ by 10 feet until the end of the turn, provided the item isn't [incapacitated](І\
...
"source":
  - "TCE"
"image": "Інструменти%20ДМ/CLI/bestiary/construct/token/dancing-item-tce.webp"
```
^statblock