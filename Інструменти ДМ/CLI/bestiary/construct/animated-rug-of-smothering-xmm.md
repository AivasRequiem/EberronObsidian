...
---
# [Animated Rug of Smothering](Інструменти ДМ\CLI\bestiary\construct/animated-rug-of-smothering-xmm.md)
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/construct/token/animated-rug-of-smothering-xmm.webp"
```
^statblock
