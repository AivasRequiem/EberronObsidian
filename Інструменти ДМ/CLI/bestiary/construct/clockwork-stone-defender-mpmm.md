...
---
# [Clockwork Stone Defender](Інструменти ДМ\CLI\bestiary\construct/clockwork-stone-defender-mpmm.md)
*Source: Mordenkainen Presents: Monsters of the Multiverse p. 80*  

The thick plates of stone riveted onto a stone [defender](Інструменти%20ДМ/CLI/items/defender-xdmg.md) give it substantial protection. Its chief role is as a bodyguard.
...
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/construct/token/clockwork-stone-defender-mpmm.webp"
```
^statblock
