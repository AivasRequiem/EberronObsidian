...
"actions":
  ...
  - "desc": "Melee  or Ranged Weapon Attack: dice:1d20+7|noform|noparens|text(+7)\
      \ to hit, reach 5 ft. or range 100/400 ft., one target. Hit: dice:2d10+4|noform|noparens|avg|text(15)\
      \ (2d10 + 4) piercing damage."
    "name": "Lancing Bolt"
  - "desc": "Ranged Weapon Attack: dice:1d20+7|noform|noparens|text(+7) to hit,\
      \ range 50/200 ft., one target. Hit: dice:1d10+4|noform|noparens|avg|text(9)\
      \ (1d10 + 4) piercing damage, and the target is [grappled](Інструменти%20Д\
      ...
      \ the clockwork. A creature takes dice:1d10|noform|noparens|avg|text(5) (d10)\
  ...
  - "desc": "The clockwork launches an explosive charge at a point within 120 feet.\
      ...
      \ a DC 15 Dexterity saving throw, taking dice:5d6|noform|noparens|avg|text(17)\
