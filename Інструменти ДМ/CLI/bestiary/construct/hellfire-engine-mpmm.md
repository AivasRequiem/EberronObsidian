...
"actions":
  ...
  - "desc": "The hellfire engine uses one of the following options (choose one or\
      ...
      \ in 1d4 hours. If the creature isn't revived before then, only a [wish](І\
      нструменти%20ДМ/CLI/spells/wish-xphb.md) spell or killing the [lemure](Інстр\
      ументи%20ДМ/CLI/bestiary/fiend/lemure-xmm.md) and casting true resurrection\
