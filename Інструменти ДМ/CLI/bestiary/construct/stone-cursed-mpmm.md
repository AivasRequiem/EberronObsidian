...
Even though a creature transformed into a stone cursed is long dead, a vague whisper of their memories lives on in the obsidian skull embedded within the stone cursed's body. At the end of a short rest, a character can make a DC 20 Intelligence ([Arcana](Інструменти%20ДМ/CLI/rules/skills.md#Arcana)) check to attempt to extract a memory from the skull that is a response to a verbal question posed to the skull by the character. Once this check is made, whether it succeeds or fails, the skull can't be used in this manner again.
...
"condition_immunities": "[charmed](Інструменти%20ДМ/CLI/rules/conditions.md#Charmed),\
  ...
  нструменти%20ДМ/CLI/rules/conditions.md#Frightened), [petrified](Інструменти%20Д\
  М/CLI/rules/conditions.md#Petrified), [poisoned](Інструменти%20ДМ/CLI/rules/conditions.md#Poisoned)"
"senses": "passive Perception 9"
"languages": "the languages it knew in life"
"cr": "1"
"traits":
  - "desc": "The stone cursed has advantage on the attack rolls of [opportunity attacks](І\
  ...
  - "desc": "If the stone cursed is motionless at the start of combat, it has advantage\
      ...
      \ cursed move or act, that creature must succeed on a DC 18 Intelligence ([Investigation](І\
      нструменти%20ДМ/CLI/rules/skills.md#Investigation)) check to discern that the\
      \ stone cursed isn't a statue."
...
"actions":
  - "desc": "Melee Weapon Attack: dice:1d20+5|noform|noparens|text(+5) to hit,\
      ...
      \ if the second save is successful; otherwise the target is [petrified](Інст\
      рументи%20ДМ/CLI/rules/conditions.md#Petrified) for 24 hours."
    "name": "Petrifying Claws"
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/construct/token/stone-cursed-mpmm.webp"
```
^statblock
