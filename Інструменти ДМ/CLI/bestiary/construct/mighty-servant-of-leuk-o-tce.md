...
---
# [Mighty Servant of Leuk-o](Інструменти ДМ\CLI\bestiary\construct/mighty-servant-of-leuk-o-tce.md)
...
"condition_immunities": "[blinded](Інструменти%20ДМ/CLI/rules/conditions.md#Blinded),\
  ...
  нструменти%20ДМ/CLI/rules/conditions.md#Grappled), [incapacitated](Інструменти%20Д\
  М/CLI/rules/conditions.md#Incapacitated), [paralyzed](Інструменти%20ДМ/CLI/rules/conditions.md#Paralyzed),\
...
"actions":
  - "desc": "Melee Weapon Attack: dice:1d20+17|noform|noparens|text(+17) to hit,\
      ...
      \ (4d12 + 10) force damage. Or Ranged Weapon Attack: dice:1d20+17|noform|noparens|text(+17)\
      \ to hit, range 120 ft., one target. Hit: dice:4d12+10|noform|noparens|avg|text(36)\
  ...
  - "desc": "If the servant jumps at least 25 feet as part of its movement, it can\
      ...
      \ On a failed save, a creature takes dice:4d12|noform|noparens|avg|text(26)\
      \ (4d12) bludgeoning damage and is knocked [prone](Інструменти%20ДМ/CLI/rules/conditions.md#Prone).\
      \ On a successful save, a creature takes half as much damage and isn't knocked\
      \ [prone](Інструменти%20ДМ/CLI/rules/conditions.md#Prone)."
    "name": "Crushing Leap"
"source":
  - "TCE"
"image": "Інструменти%20ДМ/CLI/bestiary/construct/token/mighty-servant-of-leuk-o-tce.webp"
```
^statblock