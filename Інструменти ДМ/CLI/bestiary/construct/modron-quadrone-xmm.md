...
- Modron Quadrone
---
# [Modron Quadrone](Інструменти ДМ\CLI\bestiary\construct/modron-quadrone-xmm.md)
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/construct/token/modron-quadrone-xmm.webp"
```
^statblock
