...
- Modron Pentadrone
---
# [Modron Pentadrone](Інструменти ДМ\CLI\bestiary\construct/modron-pentadrone-xmm.md)
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/construct/token/modron-pentadrone-xmm.webp"
```
^statblock
