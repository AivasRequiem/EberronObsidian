...
- Xorn
---
# [Xorn](Інструменти ДМ\CLI\bestiary\elemental/xorn-xmm.md)
...
"actions":
  ...
  - "desc": "Melee Attack Roll: +6, reach 5 ft. Hit: 8 (1d10 + 3) Slashing\
    ...
    "name": "Claw"
"bonus_actions":
  - "desc": "The xorn moves up to its [Speed](Інструменти%20ДМ/CLI/rules/variant-rules/speed-xphb.md)\
      \ or [Burrow Speed](Інструменти%20ДМ/CLI/rules/variant-rules/burrow-speed-xphb.md)\
      \ straight toward an enemy it can sense."
    "name": "Charge"
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/elemental/token/xorn-xmm.webp"
```
^statblock
