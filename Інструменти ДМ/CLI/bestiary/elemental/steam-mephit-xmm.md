...
- Steam Mephit
---
# [Steam Mephit](Інструменти ДМ\CLI\bestiary\elemental/steam-mephit-xmm.md)
...
"cr": "1/4"
"traits":
  - "desc": "Attack rolls against the mephit are made with [Disadvantage](Інструме\
      нти%20ДМ/CLI/rules/variant-rules/disadvantage-xphb.md) unless the mephit has\
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/elemental/token/steam-mephit-xmm.webp"
```
^statblock
