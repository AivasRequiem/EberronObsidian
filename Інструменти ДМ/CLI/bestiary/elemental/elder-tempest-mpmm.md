...
- Elder Tempest
---
# [Elder Tempest](Інструменти ДМ\CLI\bestiary\elemental/elder-tempest-mpmm.md)
...
"traits":
  - "desc": "The tempest can enter a hostile creature's space and stop there. It can\
    ...
    "name": "Air Form"
  - "desc": "The tempest doesn't provoke [opportunity attacks](Інструменти%20ДМ/CLI/rules/actions.md#Opportunity%20Attack)\
  ...
  - "desc": "The tempest is always at the center of a storm dice:1d6+4|noform|noparens|avg\
      ...
      \ extinguishes open flames and imposes disadvantage on Wisdom ([Perception](І\
      нструменти%20ДМ/CLI/rules/skills.md#Perception)) checks that rely on hearing.\
      \ In addition, strong winds swirl in the area covered by the storm. The winds\
      \ impose disadvantage on ranged attack rolls. They also extinguish open flames\
      \ and disperse fog."
    "name": "Living Storm"
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: dice:1d20+16|noform|noparens|text(+16) to hit,\
      \ reach 20 ft., one target. Hit: dice:4d6+9|noform|noparens|avg|text(23)\
  ...
  - "desc": "Each creature within 120 feet of the tempest must make a DC 21 Dexterity\
      ...
      \ target's saving throw fails by 5 or more, the creature is also [stunned](І\
...
"legendary_actions":
  ...
  - "desc": "The tempest releases a blast of thunder and wind in a line that is 300\
      ...
      \ damage and be flung up to 60 feet in a direction away from the line. If a\
      \ thrown target collides with an immovable object (such as a wall or floor)\
      \ or another creature, the target takes dice:1d6|noform|noparens|avg|text(3)\
      \ (d6) bludgeoning damage for every 10 feet it was thrown before impact. If\
      \ the target collides with another creature, that other creature must succeed\
      \ on a DC 19 Dexterity saving throw or take the same impact damage and be knocked\
      \ [prone](Інструменти%20ДМ/CLI/rules/conditions.md#Prone)."
    "name": "Screaming Gale (Costs 3 Actions)"
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/elemental/token/elder-tempest-mpmm.webp"
```
^statblock
