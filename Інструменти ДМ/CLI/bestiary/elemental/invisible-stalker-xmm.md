...
- Invisible Stalker
---
# [Invisible Stalker](Інструменти ДМ\CLI\bestiary\elemental/invisible-stalker-xmm.md)
...
"traits":
  - "desc": "The stalker can enter an enemy's space and stop there. It can move through\
    ...
    "name": "Air Form"
  - "desc": "The stalker has the [Invisible](Інструменти%20ДМ/CLI/rules/conditions.md#Invisible)\
      \ condition."
    "name": "Invisibility"
"actions":
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/elemental/token/invisible-stalker-xmm.webp"
```
^statblock
