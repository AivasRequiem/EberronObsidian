...
- Firenewt Warrior
---
# [Firenewt Warrior](Інструменти ДМ\CLI\bestiary\elemental/firenewt-warrior-mpmm.md)
...
"ac": !!int "13"
"ac_class": "[shield](Інструменти%20ДМ/CLI/items/shield-xphb.md)"
"hp": !!int "27"
"hit_dice": "5d8 + 5"
"modifier": !!int "1"
"stats":
...
"actions":
  ...
  - "desc": "The firenewt spits fire at a creature within 10 feet of it. The creature\
      \ must make a DC 11 Dexterity saving throw, taking dice:2d8|noform|noparens|avg|text(9)\
...
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/elemental/token/firenewt-warrior-mpmm.webp"
```
^statblock
