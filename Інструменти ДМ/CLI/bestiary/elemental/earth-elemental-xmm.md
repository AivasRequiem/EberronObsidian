...
- Earth Elemental
---
# [Earth Elemental](Інструменти ДМ\CLI\bestiary\elemental/earth-elemental-xmm.md)
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/elemental/token/earth-elemental-xmm.webp"
```
^statblock
