...
- Elemental Spirit
---
# [Elemental Spirit](Інструменти ДМ\CLI\bestiary\elemental/elemental-spirit-xphb.md)
...
"source":
  - "XPHB"
"image": "Інструменти%20ДМ/CLI/bestiary/elemental/token/elemental-spirit-xphb.webp"
```
^statblock