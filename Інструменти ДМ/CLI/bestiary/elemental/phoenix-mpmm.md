...
- Phoenix
---
# [Phoenix](Інструменти ДМ\CLI\bestiary\elemental/phoenix-mpmm.md)
...
"traits":
  - "desc": "If the phoenix dies, it explodes. Each creature in 60-foot-radius sphere\
      \ centered on the phoenix must make a DC 20 Dexterity saving throw, taking dice:4d10|noform|noparens|avg|text(22)\
      ...
      \ an egg-shaped cinder, which weighs 5 pounds. The cinder deals dice:6d6|noform|noparens|avg|text(21)\
      \ (6d6) fire damage to any creature that touches it, though no more than once\
      \ per round. The cinder is immune to all damage, and after dice:1d6|noform|noparens|avg\
      \ (d6) days, it hatches a new phoenix."
  ...
  - "desc": "The phoenix can move through a space as narrow as 1 inch wide without\
      ...
      \ attack while within 5 feet of it takes dice:1d10|noform|noparens|avg|text(5)\
      \ (d10) fire damage. In addition, the phoenix can enter a hostile creature's\
      \ space and stop there. The first time it enters a creature's space on a turn,\
      \ that creature takes dice:1d10|noform|noparens|avg|text(5) (d10) fire damage.\n\
      \nWith a touch, the phoenix can also ignite flammable objects that aren't worn\
      \ or carried (no action required)."
    "name": "Fire Form"
  - "desc": "The phoenix doesn't provoke [opportunity attacks](Інструменти%20ДМ/CLI/rules/actions.md#Opportunity%20Attack)\
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: dice:1d20+13|noform|noparens|text(+13) to hit,\
      \ reach 15 ft., one target. Hit: dice:2d6+8|noform|noparens|avg|text(15)\
      \ (2d6 + 8) fire damage."
    "name": "Beak"
  - "desc": "Melee Weapon Attack: dice:1d20+13|noform|noparens|text(+13) to hit,\
      \ reach 15 ft., one target. Hit: dice:2d8+8|noform|noparens|avg|text(17)\
      \ (2d8 + 8) fire damage."
    "name": "Fiery Talons"
"legendary_actions":
...
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/elemental/token/phoenix-mpmm.webp"
```
^statblock
