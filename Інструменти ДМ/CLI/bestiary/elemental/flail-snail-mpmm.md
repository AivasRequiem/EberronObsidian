...
- Flail Snail
---
# [Flail Snail](Інструменти ДМ\CLI\bestiary\elemental/flail-snail-mpmm.md)
...
Many hunters seek the shell for its antimagic properties. A skilled armorer can make three shields from one shell. For 1 month, each shield gives its wielder the snail's Antimagic Shell trait. When the shield's magic fades, it becomes an exotic shield that is the perfect item from which to make a [spellguard shield](Інструменти%20ДМ/CLI/items/spellguard-shield-xdmg.md).

A flail snail shell can also be used to make a [robe of scintillating colors](Інструменти%20ДМ/CLI/items/robe-of-scintillating-colors-xdmg.md). The shell is ground and added to the dye applied to the fabric. The powder is also a material component of the ritual that enchants the robe.
...
"traits":
  - "desc": "The snail has advantage on saving throws against spells, and any creature\
      ...
      \ throw, taking dice:1d6|noform|noparens|avg|text(3) (d6) force damage per\
      \ level of the spell on a failed save, or half as much damage on a successful\
      \ one."
...
"actions":
  ...
  - "desc": "The snail's shell emits dazzling, colored light until the end of the\
      ...
      \ must succeed on a DC 15 Wisdom saving throw or be [stunned](Інструменти%20Д\
      М/CLI/rules/conditions.md#Stunned) until the light ends."
  ...
  - "desc": "The flail snail withdraws into its shell. Until it emerges, it gains\
      \ a +4 bonus to its AC and is [restrained](Інструменти%20ДМ/CLI/rules/conditions.md#Restrained).\
      \ It can emerge from its shell as a bonus action on its turn."
    "name": "Shell Defense"
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/elemental/token/flail-snail-mpmm.webp"
```
^statblock
