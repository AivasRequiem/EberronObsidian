...
---
# [Lizardfolk Geomancer](Інструменти ДМ\CLI\bestiary\elemental/lizardfolk-geomancer-xmm.md)
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/elemental/token/lizardfolk-geomancer-xmm.webp"
```
^statblock
