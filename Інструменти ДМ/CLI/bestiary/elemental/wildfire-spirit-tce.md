...
- Wildfire Spirit
---
# [Wildfire Spirit](Інструменти ДМ\CLI\bestiary\elemental/wildfire-spirit-tce.md)
...
"source":
  - "TCE"
"image": "Інструменти%20ДМ/CLI/bestiary/elemental/token/wildfire-spirit-tce.webp"
```
^statblock