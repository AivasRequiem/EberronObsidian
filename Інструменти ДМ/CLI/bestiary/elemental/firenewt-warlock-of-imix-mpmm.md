...
---
# [Firenewt Warlock of Imix](Інструменти ДМ\CLI\bestiary\elemental/firenewt-warlock-of-imix-mpmm.md)
...
"traits":
  - "desc": "The firenewt can breathe air and water."
    "name": "Amphibious"
  - "desc": "Magical darkness doesn't impede the firenewt's [darkvision](Інструмен\
...
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/elemental/token/firenewt-warlock-of-imix-mpmm.webp"
```
^statblock
