...
- Giant Strider
---
# [Giant Strider](Інструменти ДМ\CLI\bestiary\elemental/giant-strider-mpmm.md)
...
"actions":
  ...
  - "desc": "The giant strider hurls a gout of flame at a point it can see within\
      ...
      \ must make a DC 12 Dexterity saving throw, taking dice:4d6|noform|noparens|avg|text(14)\
      \ (4d6) fire damage on a failed save, or half as much damage on a successful\
      \ one. The fire spreads around corners, and it ignites flammable objects in\
      \ that area that aren't being worn or carried"
    "name": "Fire Burst (Recharge 5-6)"
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/elemental/token/giant-strider-mpmm.webp"
```
^statblock
