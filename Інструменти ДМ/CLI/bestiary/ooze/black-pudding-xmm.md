...
- Black Pudding
---
# [Black Pudding](Інструменти ДМ\CLI\bestiary\ooze/black-pudding-xmm.md)
...
"traits":
  ...
  - "desc": "A creature that hits the pudding with a melee attack roll takes 4 (d8)\
      ...
      \ -5. The penalty can be removed by casting the [Mending](Інструменти%20ДМ/CLI/spells/mending-xphb.md)\
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/ooze/token/black-pudding-xmm.webp"
```
^statblock
