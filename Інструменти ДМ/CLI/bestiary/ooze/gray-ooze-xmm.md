...
- Gray Ooze
---
# [Gray Ooze](Інструменти ДМ\CLI\bestiary\ooze/gray-ooze-xmm.md)
...
"traits":
  ...
  - "desc": "Nonmagical ammunition is destroyed immediately after hitting the ooze\
      ...
      \ can be removed by casting the [Mending](Інструменти%20ДМ/CLI/spells/mending-xphb.md)\
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/ooze/token/gray-ooze-xmm.webp"
```
^statblock
