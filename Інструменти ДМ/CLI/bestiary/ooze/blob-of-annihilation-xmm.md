...
---
# [Blob of Annihilation](Інструменти ДМ\CLI\bestiary\ooze/blob-of-annihilation-xmm.md)
...
"traits":
  ...
  - "desc": "The blob has [Advantage](Інструменти%20ДМ/CLI/rules/variant-rules/advantage-xphb.md)\
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/ooze/token/blob-of-annihilation-xmm.webp"
```
^statblock
