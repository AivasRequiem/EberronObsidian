...
"regional_effects":
  - "desc": "The region containing a sphinx of lore's or sphinx of valor's lair is\
      ...
      \ While in its lair, the sphinx can cast [Clairvoyance](Інструменти%20ДМ/CLI/spells/clairvoyance-xphb.md),\
      ...
      \ a [Study](Інструменти%20ДМ/CLI/rules/actions.md#Study) action while within\
      \ 1 mile of the lair, it adds 1d6 to any ability check it makes for that action.\
