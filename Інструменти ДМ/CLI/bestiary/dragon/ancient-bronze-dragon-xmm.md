...
"regional_effects":
  - "desc": "The region containing an adult or ancient bronze dragon's lair is changed\
      ...
      \ Creatures within 1 mile of the lair that lack a [Swim Speed](Інструменти%20Д\
      М/CLI/rules/variant-rules/swim-speed-xphb.md) ignore the extra cost of movement\
      \ while swimming.  \n- **Sun and Storms.** While in its lair, the dragon can\
      \ cast [Control Weather](Інструменти%20ДМ/CLI/spells/control-weather-xphb.md),\
