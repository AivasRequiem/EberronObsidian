...
---
# [Sapphire Dragon Wyrmling](Інструменти ДМ\CLI\bestiary\dragon/sapphire-dragon-wyrmling-ftd.md)
...
"source":
  - "FTD"
"image": "Інструменти%20ДМ/CLI/bestiary/dragon/token/sapphire-dragon-wyrmling-ftd.webp"
```
^statblock