...
"actions":
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \ (level 3 version)\n\n**1/day each:** [Scrying](Інструменти%20ДМ/CLI/spells/scrying-xphb.md),\
...
"legendary_actions":
  - "desc": "The dragon uses Spellcasting to cast [Invisibility](Інструменти%20ДМ\
      ...
      \ Speed](Інструменти%20ДМ/CLI/rules/variant-rules/fly-speed-xphb.md). The dragon\
      \ can't take this action again until the start of its next turn."
    "name": "Cloaked Flight"
  - "desc": "The dragon uses Spellcasting to cast [Shatter](Інструменти%20ДМ/CLI/spells/shatter-xphb.md)\
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/dragon/token/ancient-blue-dragon-xmm.webp"
```
^statblock
