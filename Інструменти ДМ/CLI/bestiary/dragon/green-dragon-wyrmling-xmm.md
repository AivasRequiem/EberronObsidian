...
---
# [Green Dragon Wyrmling](Інструменти ДМ\CLI\bestiary\dragon/green-dragon-wyrmling-xmm.md)
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/dragon/token/green-dragon-wyrmling-xmm.webp"
```
^statblock
