...
- Adult Red Dragon
---
# [Adult Red Dragon](Інструменти ДМ\CLI\bestiary\dragon/adult-red-dragon-xmm.md)
...
"legendary_actions":
  ...
  - "desc": "The dragon uses Spellcasting to cast [Scorching Ray](Інструменти%20ДМ\
      /CLI/spells/scorching-ray-xphb.md). The dragon can't take this action again\
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/dragon/token/adult-red-dragon-xmm.webp"
```
^statblock
