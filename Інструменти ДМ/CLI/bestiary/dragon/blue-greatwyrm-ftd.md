...
- Blue Greatwyrm
---
# [Blue Greatwyrm](Інструменти ДМ\CLI\bestiary\dragon/blue-greatwyrm-ftd.md)
...
"actions":
  ...
  - "desc": "The greatwyrm exhales a blast of energy in a 300-foot cone. Each creature\
      ...
      \ creature takes dice:12d12|noform|noparens|avg|text(78) (12d12) lightning\
...
"source":
  - "FTD"
"image": "Інструменти%20ДМ/CLI/bestiary/dragon/token/blue-greatwyrm-ftd.webp"
```
^statblock