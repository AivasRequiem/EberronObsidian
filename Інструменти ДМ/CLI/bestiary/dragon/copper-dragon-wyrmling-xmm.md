...
---
# [Copper Dragon Wyrmling](Інструменти ДМ\CLI\bestiary\dragon/copper-dragon-wyrmling-xmm.md)
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/dragon/token/copper-dragon-wyrmling-xmm.webp"
```
^statblock
