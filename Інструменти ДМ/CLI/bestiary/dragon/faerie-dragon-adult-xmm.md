...
- Faerie Dragon Adult
---
# [Faerie Dragon Adult](Інструменти ДМ\CLI\bestiary\dragon/faerie-dragon-adult-xmm.md)
...
"actions":
  ...
  - "desc": "*Wisdom Saving Throw:* DC 13, each creature in a 15-foot [Cone](Інстр\
      ...
      \ While [Incapacitated](Інструменти%20ДМ/CLI/rules/conditions.md#Incapacitated),\
...
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/dragon/token/faerie-dragon-adult-xmm.webp"
```
^statblock
