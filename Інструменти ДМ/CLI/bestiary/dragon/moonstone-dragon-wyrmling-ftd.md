...
---
# [Moonstone Dragon Wyrmling](Інструменти ДМ\CLI\bestiary\dragon/moonstone-dragon-wyrmling-ftd.md)
...
"actions":
  ...
  - "desc": "The dragon uses one of the following breath weapons:\n\n- **Dream Breath.**\
      ...
      \ succeed on a DC 12 Constitution saving throw or fall [unconscious](Інструм\
...
"source":
  - "FTD"
"image": "Інструменти%20ДМ/CLI/bestiary/dragon/token/moonstone-dragon-wyrmling-ftd.webp"
```
^statblock