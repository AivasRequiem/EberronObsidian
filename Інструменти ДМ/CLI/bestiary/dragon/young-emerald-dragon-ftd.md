...
---
# [Young Emerald Dragon](Інструменти ДМ\CLI\bestiary\dragon/young-emerald-dragon-ftd.md)
...
"actions":
  ...
  - "desc": "The dragon casts one of the following spells, requiring no spell components\
      ...
      \ [invisibility](Інструменти%20ДМ/CLI/spells/invisibility-xphb.md), [silent\
      \ image](Інструменти%20ДМ/CLI/spells/silent-image-xphb.md)"
    "name": "Spellcasting (Psionics)"
"source":
  - "FTD"
"image": "Інструменти%20ДМ/CLI/bestiary/dragon/token/young-emerald-dragon-ftd.webp"
```
^statblock