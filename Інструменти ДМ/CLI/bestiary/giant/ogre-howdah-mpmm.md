...
- Ogre Howdah
---
# [Ogre Howdah](Інструменти ДМ\CLI\bestiary\giant/ogre-howdah-mpmm.md)
*Source: Mordenkainen Presents: Monsters of the Multiverse p. 201*  

The most unusual of the specialized ogres, the howdah carries a palisaded wooden fort on its back. The fort serves as a fighting platform for up to four Small people. Ogre howdahs are most often seen bearing bow- and spear-wielding [goblins](Інструменти%20ДМ/CLI/bestiary/fey/goblin-warrior-xmm.md) into battle, or perhaps [kobolds](Інструменти%20ДМ/CLI/bestiary/dragon/kobold-warrior-xmm.md) or deep gnomes, but they might also transport other Small folk.
...
"source":
  - "MPMM"
"image": "Інструменти%20ДМ/CLI/bestiary/giant/token/ogre-howdah-mpmm.webp"
```
^statblock
