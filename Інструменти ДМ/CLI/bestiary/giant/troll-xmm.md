...
- Troll
---
# [Troll](Інструменти ДМ\CLI\bestiary\giant/troll-xmm.md)
...
"traits":
  - "desc": "If the troll ends any turn [Bloodied](Інструменти%20ДМ/CLI/rules/conditions.md#Bloodied)\
      ...
      \ the troll's turn. The troll has 1 [Exhaustion](Інструменти%20ДМ/CLI/rules/conditions.md#Exhaustion)\
      \ level for each missing limb, and it grows replacement limbs the next time\
      \ it regains [Hit Points](Інструменти%20ДМ/CLI/rules/variant-rules/hit-points-xphb.md)."
    "name": "Loathsome Limbs (4/Day)"
  - "desc": "The troll regains 15 [Hit Points](Інструменти%20ДМ/CLI/rules/variant-rules/hit-points-xphb.md)\
      ...
      \ if it starts its turn with 0 [Hit Points](Інструменти%20ДМ/CLI/rules/variant-rules/hit-points-xphb.md)\
...
"actions":
  ...
  - "desc": "Melee Attack Roll: +7, reach 10 ft. Hit: 11 (2d6 + 4) Slashing\
    ...
    "name": "Rend"
"bonus_actions":
  - "desc": "The troll moves up to half its [Speed](Інструменти%20ДМ/CLI/rules/variant-rules/speed-xphb.md)\
      \ straight toward an enemy it can see."
    "name": "Charge"
"source":
  - "XMM"
"image": "Інструменти%20ДМ/CLI/bestiary/giant/token/troll-xmm.webp"
```
^statblock
