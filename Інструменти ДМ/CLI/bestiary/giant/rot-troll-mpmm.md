...
"traits":
  - "desc": "At the end of each of the troll's turns, each creature within 5 feet\
      \ of it takes dice:2d10|noform|noparens|avg|text(11) (2d10) necrotic damage,\
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: dice:1d20+8|noform|noparens|text(+8) to hit,\
      ...
      \ (1d10 + 4) piercing damage plus dice:3d10|noform|noparens|avg|text(16)\
      \ (3d10) necrotic damage."
    "name": "Bite"
  - "desc": "Melee Weapon Attack: dice:1d20+8|noform|noparens|text(+8) to hit,\
      \ reach 5 ft., one target. Hit: dice:2d6+4|noform|noparens|avg|text(11)\
      \ (2d6 + 4) slashing damage plus dice:2d6|noform|noparens|avg|text(7) (2d6)\
      \ necrotic damage."
    "name": "Claws"
"source":
  - "MPMM"
