...
- **Prerequisites**: Ability to use an [Arcane Focus](Інструменти%20ДМ/CLI/items/arcane-focus-xphb.md) or tool as a [Spellcasting Focus](Інструменти%20ДМ/CLI/rules/variant-rules/spellcasting-focus-xphb.md)
- **Space**: Roomy (16 sq)
- **Hirelings**: 1
- **Order**: craft
