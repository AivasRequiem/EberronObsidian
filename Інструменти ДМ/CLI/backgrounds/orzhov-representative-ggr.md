...
- **Skill Proficiencies.** [Intimidation](Інструменти%20ДМ/CLI/rules/skills.md#Intimidation), [Religion](Інструменти%20ДМ/CLI/rules/skills.md#Religion)  
- **Languages.** Two of your choice  
- **Equipment.** An Orzhov insignia, a foot-long chain made of ten gold coins, vestments, a set of [fine clothes](Інструменти%20ДМ/CLI/items/fine-clothes-xphb.md), and a belt [pouch](Інструменти%20ДМ/CLI/items/pouch-xphb.md) containing 1 pp (an Orzhov-minted 10-zino coin)  
...
| Spell Level | Spells |
|-------------|--------|
| Cantrip | [friends](Інструменти%20ДМ/CLI/spells/friends-xphb.md), [guidance](Інструменти%20ДМ/CLI/spells/guidance-xphb.md) |
| 1st | [command](Інструменти%20ДМ/CLI/spells/command-xphb.md), [illusory script](Інструменти%20ДМ/CLI/spells/illusory-script-xphb.md) |
| 2nd | [enthrall](Інструменти%20ДМ/CLI/spells/enthrall-xphb.md), [ray of enfeeblement](Інструменти%20ДМ/CLI/spells/ray-of-enfeeblement-xphb.md), [zone of truth](Інструменти%20ДМ/CLI/spells/zone-of-truth-xphb.md) |
| 3rd | [bestow curse](Інструменти%20ДМ/CLI/spells/bestow-curse-xphb.md), [speak with dead](Інструменти%20ДМ/CLI/spells/speak-with-dead-xphb.md), [spirit guardians](Інструменти%20ДМ/CLI/spells/spirit-guardians-xphb.md) |
| 4th | [blight](Інструменти%20ДМ/CLI/spells/blight-xphb.md), [death ward](Інструменти%20ДМ/CLI/spells/death-ward-xphb.md), [Leomund's secret chest](Інструменти%20ДМ/CLI/spells/leomunds-secret-chest-xphb.md) |
| 5th | [geas](Інструменти%20ДМ/CLI/spells/geas-xphb.md) |
^orzhov-guild-spells
