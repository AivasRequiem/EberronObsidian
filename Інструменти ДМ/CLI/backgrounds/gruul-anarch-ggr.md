...
- **Skill Proficiencies.** [Animal Handling](Інструменти%20ДМ/CLI/rules/skills.md#Animal%20Handling), [Athletics](Інструменти%20ДМ/CLI/rules/skills.md#Athletics)  
...
- **Equipment.** A Gruul insignia, a [hunting trap](Інструменти%20ДМ/CLI/items/hunting-trap-xphb.md), an [herbalism kit](Інструменти%20ДМ/CLI/items/herbalism-kit-xphb.md), the skull of a boar, a beast-hide cloak, a set of [traveler's clothes](Інструменти%20ДМ/CLI/items/travelers-clothes-xphb.md), and a belt [pouch](Інструменти%20ДМ/CLI/items/pouch-xphb.md) containing 10 gp (Azorius 1-zino coins)  
...
| Spell Level | Spells |
|-------------|--------|
| Cantrip | [fire bolt](Інструменти%20ДМ/CLI/spells/fire-bolt-xphb.md), [produce flame](Інструменти%20ДМ/CLI/spells/produce-flame-xphb.md) |
| 1st | [compelled duel](Інструменти%20ДМ/CLI/spells/compelled-duel-xphb.md), [speak with animals](Інструменти%20ДМ/CLI/spells/speak-with-animals-xphb.md), [thunderwave](Інструменти%20ДМ/CLI/spells/thunderwave-xphb.md) |
| 2nd | [beast sense](Інструменти%20ДМ/CLI/spells/beast-sense-xphb.md), [shatter](Інструменти%20ДМ/CLI/spells/shatter-xphb.md) |
| 3rd | [conjure animals](Інструменти%20ДМ/CLI/spells/conjure-animals-xphb.md), [conjure barrage](Інструменти%20ДМ/CLI/spells/conjure-barrage-xphb.md) |
| 4th | [dominate beast](Інструменти%20ДМ/CLI/spells/dominate-beast-xphb.md), [stoneskin](Інструменти%20ДМ/CLI/spells/stoneskin-xphb.md) |
| 5th | [destructive wave](Інструменти%20ДМ/CLI/spells/destructive-wave-xphb.md) |
^gruul-guild-spells
