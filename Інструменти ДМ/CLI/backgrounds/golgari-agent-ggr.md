...
- **Skill Proficiencies.** [Nature](Інструменти%20ДМ/CLI/rules/skills.md#Nature), [Survival](Інструменти%20ДМ/CLI/rules/skills.md#Survival)  
- **Tool Proficiencies.** [Poisoner's kit](Інструменти%20ДМ/CLI/items/poisoners-kit-xphb.md)  
- **Languages.** Choose one of Elvish, Giant, or Kraul  
- **Equipment.** A Golgari insignia, a [poisoner's kit](Інструменти%20ДМ/CLI/items/poisoners-kit-xphb.md), a pet beetle or spider, a set of common clothes, and a belt [pouch](Інструменти%20ДМ/CLI/items/pouch-xphb.md) containing 10 gp worth of mixed coins  
...
| Spell Level | Spells |
|-------------|--------|
| Cantrip | [dancing lights](Інструменти%20ДМ/CLI/spells/dancing-lights-xphb.md), [spare the dying](Інструменти%20ДМ/CLI/spells/spare-the-dying-xphb.md) |
| 1st | [entangle](Інструменти%20ДМ/CLI/spells/entangle-xphb.md), [ray of sickness](Інструменти%20ДМ/CLI/spells/ray-of-sickness-xphb.md) |
| 2nd | [protection from poison](Інструменти%20ДМ/CLI/spells/protection-from-poison-xphb.md), [ray of enfeeblement](Інструменти%20ДМ/CLI/spells/ray-of-enfeeblement-xphb.md), [spider climb](Інструменти%20ДМ/CLI/spells/spider-climb-xphb.md) |
| 3rd | [animate dead](Інструменти%20ДМ/CLI/spells/animate-dead-xphb.md), [plant growth](Інструменти%20ДМ/CLI/spells/plant-growth-xphb.md) |
| 4th | [giant insect](Інструменти%20ДМ/CLI/spells/giant-insect-xphb.md), [grasping vine](Інструменти%20ДМ/CLI/spells/grasping-vine-xphb.md) |
| 5th | [cloudkill](Інструменти%20ДМ/CLI/spells/cloudkill-xphb.md), [insect plague](Інструменти%20ДМ/CLI/spells/insect-plague-xphb.md) |
^golgari-guild-spells
