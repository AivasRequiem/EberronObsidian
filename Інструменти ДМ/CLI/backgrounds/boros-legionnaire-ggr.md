...
- **Equipment.** A Boros insignia, a feather from an angel's wing, a tattered piece of a Boros banner (a souvenir from a famous battle), a set of common clothes, and a belt [pouch](Інструменти%20ДМ/CLI/items/pouch-xphb.md) containing 2 gp (Boros-minted 1-zino coins)  
...
| Spell Level | Spells |
|-------------|--------|
| Cantrip | [fire bolt](Інструменти%20ДМ/CLI/spells/fire-bolt-xphb.md), [sacred flame](Інструменти%20ДМ/CLI/spells/sacred-flame-xphb.md) |
| 1st | [guiding bolt](Інструменти%20ДМ/CLI/spells/guiding-bolt-xphb.md), [heroism](Інструменти%20ДМ/CLI/spells/heroism-xphb.md) |
| 2nd | [aid](Інструменти%20ДМ/CLI/spells/aid-xphb.md), [scorching ray](Інструменти%20ДМ/CLI/spells/scorching-ray-xphb.md) |
| 3rd | [beacon of hope](Інструменти%20ДМ/CLI/spells/beacon-of-hope-xphb.md), [blinding smite](Інструменти%20ДМ/CLI/spells/blinding-smite-xphb.md) |
| 4th | [death ward](Інструменти%20ДМ/CLI/spells/death-ward-xphb.md), [wall of fire](Інструменти%20ДМ/CLI/spells/wall-of-fire-xphb.md) |
| 5th | [flame strike](Інструменти%20ДМ/CLI/spells/flame-strike-xphb.md) |
^boros-guild-spells
