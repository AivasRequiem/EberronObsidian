...
**Improved Dash.** When you take the [Dash](Інструменти%20ДМ/CLI/rules/actions.md#Dash) action, your [Speed](Інструменти%20ДМ/CLI/rules/variant-rules/speed-xphb.md) increases by 10 feet for that action.
