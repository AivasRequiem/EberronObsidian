...
|----------------|--------|
| 3rd | [Aid](Інструменти%20ДМ/CLI/spells/aid-xphb.md), [Alarm](Інструменти%20ДМ/CLI/spells/alarm-xphb.md), [Lesser Restoration](Інструменти%20ДМ/CLI/spells/lesser-restoration-xphb.md), [Protection from Evil and Good](Інструменти%20ДМ/CLI/spells/protection-from-evil-and-good-xphb.md) |
| 5th | [Dispel Magic](Інструменти%20ДМ/CLI/spells/dispel-magic-xphb.md), [Protection From Energy](Інструменти%20ДМ/CLI/spells/protection-from-energy-xphb.md) |
| 7th | [Freedom of Movement](Інструменти%20ДМ/CLI/spells/freedom-of-movement-xphb.md), [Summon Construct](Інструменти%20ДМ/CLI/spells/summon-construct-xphb.md) |
| 9th | [Greater Restoration](Інструменти%20ДМ/CLI/spells/greater-restoration-xphb.md), [Wall of Force](Інструменти%20ДМ/CLI/spells/wall-of-force-xphb.md) |
^clockwork-spells
...
| 5 | Your [Spellcasting Focus](Інструменти%20ДМ/CLI/rules/variant-rules/spellcasting-focus-xphb.md) temporarily takes the form of a Tiny clockwork mechanism. |
...
You can tap into the grand equation of existence to imbue a creature with a shimmering shield of order. As a [Magic](Інструменти%20ДМ/CLI/rules/actions.md#Magic) action, you can expend 1 to 5 Sorcery Points to create a magical ward around yourself or another creature you can see within 30 feet of yourself. The ward is represented by a number of d8s equal to the number of Sorcery Points spent to create it. When the warded creature takes damage, it can expend a number of those dice, roll them, and reduce the damage taken by the total rolled on those dice.

The ward lasts until you finish a [Long Rest](Інструменти%20ДМ/CLI/rules/variant-rules/long-rest-xphb.md) or until you use this feature again.
...
You momentarily summon spirits of order to expunge disorder around you. As a [Magic](Інструменти%20ДМ/CLI/rules/actions.md#Magic) action, you summon the spirits in a 30-foot [Cube](Інструменти%20ДМ/CLI/rules/variant-rules/cube-area-of-effect-xphb.md) originating from you. The spirits look like modrons or other Constructs of your choice. The spirits are intangible and invulnerable, and they create the effects below within the [Cube](Інструменти%20ДМ/CLI/rules/variant-rules/cube-area-of-effect-xphb.md) before vanishing. Once you use this action, you can't use it again until you finish a [Long Rest](Інструменти%20ДМ/CLI/rules/variant-rules/long-rest-xphb.md) unless you spend 7 Sorcery Points (no action required) to restore your use of it.

#### Heal

The spirits restore up to 100 [Hit Points](Інструменти%20ДМ/CLI/rules/variant-rules/hit-points-xphb.md), divided as you choose among any number of creatures of your choice in the [Cube](Інструменти%20ДМ/CLI/rules/variant-rules/cube-area-of-effect-xphb.md).

#### Repair

Any damaged objects entirely in the [Cube](Інструменти%20ДМ/CLI/rules/variant-rules/cube-area-of-effect-xphb.md) are repaired instantly.

#### Dispel

Every spell of level 6 and lower ends on creatures and objects of your choice in the [Cube](Інструменти%20ДМ/CLI/rules/variant-rules/cube-area-of-effect-xphb.md).