...
|---------------|--------|
| 3 | [Burning Hands](Інструменти%20ДМ/CLI/spells/burning-hands-xphb.md), [Command](Інструменти%20ДМ/CLI/spells/command-xphb.md), [Scorching Ray](Інструменти%20ДМ/CLI/spells/scorching-ray-xphb.md), [Suggestion](Інструменти%20ДМ/CLI/spells/suggestion-xphb.md) |
| 5 | [Fireball](Інструменти%20ДМ/CLI/spells/fireball-xphb.md), [Stinking Cloud](Інструменти%20ДМ/CLI/spells/stinking-cloud-xphb.md) |
| 7 | [Fire Shield](Інструменти%20ДМ/CLI/spells/fire-shield-xphb.md), [Wall of Fire](Інструменти%20ДМ/CLI/spells/wall-of-fire-xphb.md) |
| 9 | [Geas](Інструменти%20ДМ/CLI/spells/geas-xphb.md), [Insect Plague](Інструменти%20ДМ/CLI/spells/insect-plague-xphb.md) |
^fiend-spells

### Dark One's Blessing (Level 3)

When you reduce an enemy to 0 [Hit Points](Інструменти%20ДМ/CLI/rules/variant-rules/hit-points-xphb.md), you gain [Temporary Hit Points](Інструменти%20ДМ/CLI/rules/variant-rules/temporary-hit-points-xphb.md) equal to your Charisma modifier plus your Warlock level (minimum of 1 [Temporary Hit Point](Інструменти%20ДМ/CLI/rules/variant-rules/temporary-hit-points-xphb.md)). You also gain this benefit if someone else reduces an enemy within 10 feet of you to 0 [Hit Points](Інструменти%20ДМ/CLI/rules/variant-rules/hit-points-xphb.md).
...
Choose one damage type, other than Force, whenever you finish a [Short](Інструменти%20ДМ/CLI/rules/variant-rules/short-rest-xphb.md) or [Long Rest](Інструменти%20ДМ/CLI/rules/variant-rules/long-rest-xphb.md). You have [Resistance](Інструменти%20ДМ/CLI/rules/variant-rules/resistance-xphb.md) to that damage type until you choose a different one with this feature.
