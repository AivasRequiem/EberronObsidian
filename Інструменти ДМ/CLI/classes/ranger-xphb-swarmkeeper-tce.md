...
You learn the [mage hand](Інструменти%20ДМ/CLI/spells/mage-hand-xphb.md) cantrip if you don't already know it. When you cast it, the hand takes the form of your swarming nature spirits.
...
| Ranger Level | Spells |
|--------------|--------|
| 3rd | [faerie fire](Інструменти%20ДМ/CLI/spells/faerie-fire-xphb.md) |
| 5th | [web](Інструменти%20ДМ/CLI/spells/web-xphb.md) |
| 9th | [gaseous form](Інструменти%20ДМ/CLI/spells/gaseous-form-xphb.md) |
| 13th | [arcane eye](Інструменти%20ДМ/CLI/spells/arcane-eye-xphb.md) |
| 17th | [insect plague](Інструменти%20ДМ/CLI/spells/insect-plague-xphb.md) |
^swarmkeeper-spells
...
You can condense part of your swarm into a focused mass that lifts you up. As a bonus action, you gain a flying speed of 10 feet and can hover. This effect lasts for 1 minute or until you are [incapacitated](Інструменти%20ДМ/CLI/rules/conditions.md#Incapacitated).
...
- If a creature fails its saving throw against being moved by Gathered Swarm, you can also cause the swarm to knock the creature [prone](Інструменти%20ДМ/CLI/rules/conditions.md#Prone).  
