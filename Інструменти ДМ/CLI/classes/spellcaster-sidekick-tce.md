...
- **Tools**: none
- **Skills**: Two skills of your choice from the following list: [Arcana](Інструменти%20ДМ/CLI/rules/skills.md#Arcana), [History](Інструменти%20ДМ/CLI/rules/skills.md#History), [Insight](Інструменти%20ДМ/CLI/rules/skills.md#Insight), [Investigation](Інструменти%20ДМ/CLI/rules/skills.md#Investigation), [Medicine](Інструменти%20ДМ/CLI/rules/skills.md#Medicine), [Performance](Інструменти%20ДМ/CLI/rules/skills.md#Performance), [Persuasion](Інструменти%20ДМ/CLI/rules/skills.md#Persuasion), and [Religion](Інструменти%20ДМ/CLI/rules/skills.md#Religion).
...
- **Mage.** [mage hand](Інструменти%20ДМ/CLI/spells/mage-hand-xphb.md), [ray of frost](Інструменти%20ДМ/CLI/spells/ray-of-frost-xphb.md), [thunderwave](Інструменти%20ДМ/CLI/spells/thunderwave-xphb.md)  
- **Healer.** [cure wounds](Інструменти%20ДМ/CLI/spells/cure-wounds-xphb.md), [guidance](Інструменти%20ДМ/CLI/spells/guidance-xphb.md), [sacred flame](Інструменти%20ДМ/CLI/spells/sacred-flame-xphb.md)  
- **Prodigy.** [eldritch blast](Інструменти%20ДМ/CLI/spells/eldritch-blast-xphb.md), [healing word](Інструменти%20ДМ/CLI/spells/healing-word-xphb.md), [light](Інструменти%20ДМ/CLI/spells/light-xphb.md)  
...
The sidekick can use a focus for its spells depending on the choice you made on the Spellcasting table. A Mage can use an arcane focus, a Healer can use a holy symbol, and a Prodigy can use an arcane focus or a [musical instrument](Інструменти%20ДМ/CLI/items/musical-instrument-xphb.md).
...
Taking damage can't break the sidekick's [concentration](Інструменти%20ДМ/CLI/rules/conditions.md#Concentration) on a spell.