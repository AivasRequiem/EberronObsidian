...
| [Mishakal](Інструменти%20ДМ/CLI/deities/dragonlance-mishakal-phb.md) | Dragonlance |
| Selûne | Forgotten Realms |
| [Yondalla](Інструменти%20ДМ/CLI/deities/nonhuman-yondalla.md) | Halfling |
^twilight-deities
...
| Cleric Level | Spells |
|--------------|--------|
| 1st | [faerie fire](Інструменти%20ДМ/CLI/spells/faerie-fire-xphb.md), [sleep](Інструменти%20ДМ/CLI/spells/sleep-xphb.md) |
| 3rd | [moonbeam](Інструменти%20ДМ/CLI/spells/moonbeam-xphb.md), [see invisibility](Інструменти%20ДМ/CLI/spells/see-invisibility-xphb.md) |
| 5th | [aura of vitality](Інструменти%20ДМ/CLI/spells/aura-of-vitality-xphb.md), [Leomund's tiny hut](Інструменти%20ДМ/CLI/spells/leomunds-tiny-hut-xphb.md) |
| 7th | [aura of life](Інструменти%20ДМ/CLI/spells/aura-of-life-xphb.md), [greater invisibility](Інструменти%20ДМ/CLI/spells/greater-invisibility-xphb.md) |
| 9th | [circle of power](Інструменти%20ДМ/CLI/spells/circle-of-power-xphb.md), [mislead](Інструменти%20ДМ/CLI/spells/mislead-xphb.md) |
^twilight-domain-spells
...
You can see through the deepest gloom. You have [darkvision](Інструменти%20ДМ/CLI/rules/senses.md#Darkvision) out to a range of 300 feet. In that radius, you can see in dim light as if it were bright light and in darkness as if it were dim light.

As an action, you can magically share the [darkvision](Інструменти%20ДМ/CLI/rules/senses.md#Darkvision) of this feature with willing creatures you can see within 10 feet of you, up to a number of creatures equal to your Wisdom modifier (minimum of one creature). The shared [darkvision](Інструменти%20ДМ/CLI/rules/senses.md#Darkvision) lasts for 1 hour. Once you share it, you can't do so again until you finish a long rest, unless you expend a spell slot of any level to share it again.
