...
**Starting Equipment:** *Choose A, B, or C:* (A) [Chain Mail](Інструменти%20ДМ/CLI/items/chain-mail-xphb.md), [Greatsword](Інструменти%20ДМ/CLI/items/greatsword-xphb.md), [Flail](Інструменти%20ДМ/CLI/items/flail-xphb.md), 8 [Javelins](Інструменти%20ДМ/CLI/items/javelin-xphb.md), [Dungeoneer's Pack](Інструменти%20ДМ/CLI/items/dungeoneers-pack-xphb.md), and 4 GP; (B) [Studded Leather Armor](Інструменти%20ДМ/CLI/items/studded-leather-armor-xphb.md), [Scimitar](Інструменти%20ДМ/CLI/items/scimitar-xphb.md), [Shortsword](Інструменти%20ДМ/CLI/items/shortsword-xphb.md), [Longbow](Інструменти%20ДМ/CLI/items/longbow-xphb.md), [20 Arrows](Інструменти%20ДМ/CLI/items/arrows-20-xphb.md), [Quiver](Інструменти%20ДМ/CLI/items/quiver-xphb.md), [Dungeoneer's Pack](Інструменти%20ДМ/CLI/items/dungeoneers-pack-xphb.md), and 11 GP; or (C) 155 GP
...
You have honed your martial prowess and gain a Fighting Style feat of your choice. [Defense](Інструменти%20ДМ/CLI/feats/defense-xphb.md) is recommended.

Whenever you gain a Fighter level, you can replace the feat you chose with a different Fighting Style feat.

### Second Wind (Level 1)

You have a limited well of physical and mental stamina that you can draw on. As a [Bonus Action](Інструменти%20ДМ/CLI/rules/variant-rules/bonus-action-xphb.md), you can use it to regain [Hit Points](Інструменти%20ДМ/CLI/rules/variant-rules/hit-points-xphb.md) equal to `1d10` plus your Fighter level.
...
Your training with weapons allows you to use the [mastery properties](Інструменти%20ДМ/CLI/rules/variant-rules/weapon-mastery-properties-xphb.md) of three kinds of Simple or Martial weapons of your choice. Whenever you finish a [Long Rest](Інструменти%20ДМ/CLI/rules/variant-rules/long-rest-xphb.md), you can practice weapon drills and change one of those weapon choices.

When you reach certain Fighter levels, you gain the ability to use the [mastery properties](Інструменти%20ДМ/CLI/rules/variant-rules/weapon-mastery-properties-xphb.md) of more kinds of weapons, as shown in the [Weapon](Інструменти%20ДМ/CLI/rules/variant-rules/weapon-xphb.md) Mastery column of the Fighter Features table.

### Action Surge (Level 2)

You can push yourself beyond your normal limits for a moment. On your turn, you can take one additional action, except the [Magic](Інструменти%20ДМ/CLI/rules/actions.md#Magic) action.

Once you use this feature, you can't do so again until you finish a [Short](Інструменти%20ДМ/CLI/rules/variant-rules/short-rest-xphb.md) or [Long Rest](Інструменти%20ДМ/CLI/rules/variant-rules/long-rest-xphb.md). Starting at level 17, you can use it twice before a rest but only once on a turn.

### Tactical Mind (Level 2)

You have a mind for tactics on and off the battlefield. When you fail an ability check, you can expend a use of your Second Wind to push yourself toward success. Rather than regaining [Hit Points](Інструменти%20ДМ/CLI/rules/variant-rules/hit-points-xphb.md), you roll `1d10` and add the number rolled to the ability check, potentially turning it into a success. If the check still fails, this use of Second Wind isn't expended.
...
You gain the [Ability Score Improvement](Інструменти%20ДМ/CLI/feats/ability-score-improvement-xphb.md) feat or another feat of your choice for which you qualify. You gain this feature again at Fighter levels 6, 8, 12, 14, and 16.
...
Whenever you activate your Second Wind with a [Bonus Action](Інструменти%20ДМ/CLI/rules/variant-rules/bonus-action-xphb.md), you can move up to half your [Speed](Інструменти%20ДМ/CLI/rules/variant-rules/speed-xphb.md) without provoking [Opportunity Attacks](Інструменти%20ДМ/CLI/rules/actions.md#Opportunity%20Attack).
...
If you fail a saving throw, you can reroll it with a bonus equal to your Fighter level. You must use the new roll, and you can't use this feature again until you finish a [Long Rest](Інструменти%20ДМ/CLI/rules/variant-rules/long-rest-xphb.md).

You can use this feature twice before a [Long Rest](Інструменти%20ДМ/CLI/rules/variant-rules/long-rest-xphb.md) starting at level 13 and three times before a [Long Rest](Інструменти%20ДМ/CLI/rules/variant-rules/long-rest-xphb.md) starting at level 17.

### Tactical Master (Level 9)

When you attack with a weapon whose mastery property you can use, you can replace that property with the [Push](Інструменти%20ДМ/CLI/rules/item-mastery.md#Push), [Sap](Інструменти%20ДМ/CLI/rules/item-mastery.md#Sap), or [Slow](Інструменти%20ДМ/CLI/rules/item-mastery.md#Slow) property for that attack.
...
You can attack three times instead of once whenever you take the [Attack](Інструменти%20ДМ/CLI/rules/actions.md#Attack) action on your turn.
...
You study your opponents and learn from each attack you make. If you make an attack roll against a creature and miss, you have [Advantage](Інструменти%20ДМ/CLI/rules/variant-rules/advantage-xphb.md) on your next attack roll against that creature before the end of your next turn.
...
You gain an Epic Boon feat or another feat of your choice for which you qualify. [Boon of Combat Prowess](Інструменти%20ДМ/CLI/feats/boon-of-combat-prowess-xphb.md) is recommended.

### Three Extra Attacks (Level 20)

You can attack four times instead of once whenever you take the [Attack](Інструменти%20ДМ/CLI/rules/actions.md#Attack) action on your turn.