...
You gain proficiency with [smith's tools](Інструменти%20ДМ/CLI/items/smiths-tools-xphb.md), and you learn to speak, read, and write Giant.
...
> ![Rune Knight Rune](Інструменти%20ДМ/CLI/lists/list-optfeaturetype-rn.md#Rune%20Knight%20Rune)
^list-optfeature-rn