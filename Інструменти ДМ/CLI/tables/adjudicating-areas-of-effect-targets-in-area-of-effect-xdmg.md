...
*Use this column for [Cylinders](Інструменти%20ДМ/CLI/rules/variant-rules/cylinder-area-of-effect-xphb.md), [Emanations](Інструменти%20ДМ/CLI/rules/variant-rules/emanation-area-of-effect-xphb.md) (using the size of the Emanation rather than its radius), and [Spheres](Інструменти%20ДМ/CLI/rules/variant-rules/sphere-area-of-effect-xphb.md).