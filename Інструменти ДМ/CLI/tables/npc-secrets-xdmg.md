...
| 4 | The NPC is under a magical compulsion (perhaps a [Geas](Інструменти%20ДМ/CLI/spells/geas-xphb.md) spell or some kind of curse) to behave in a certain way. |
