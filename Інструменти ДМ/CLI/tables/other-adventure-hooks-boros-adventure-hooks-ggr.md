...
| 4 | Flame-kin soldiers created as part of an abandoned weapons project are suddenly reactivated and run amok. These soldiers use the [azer](Інструменти%20ДМ/CLI/bestiary/elemental/azer-sentinel-xmm.md) stat block in the "Monster Manual". |
