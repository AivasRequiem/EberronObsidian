...
| 5 | The item's bearer has advantage on Intelligence ([History](Інструменти%20ДМ/CLI/rules/skills.md#History)) checks. |
| 6 | The item's bearer has advantage on Charisma ([Intimidation](Інструменти%20ДМ/CLI/rules/skills.md#Intimidation)) checks made against non-Dragons. |
