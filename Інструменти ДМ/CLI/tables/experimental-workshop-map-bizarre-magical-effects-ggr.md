...
| 3 | The area is affected by a [guards and wards](Інструменти%20ДМ/CLI/spells/guards-and-wards-xphb.md)*spell*. |
...
| 6 | Random sections of the area are affected by an [antimagic field](Інструменти%20ДМ/CLI/spells/antimagic-field-xphb.md) spell. |
^bizarre-magical-effects