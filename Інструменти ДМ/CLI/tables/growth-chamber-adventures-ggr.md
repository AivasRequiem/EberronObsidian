...
|-----------|----------------|
| 1 | Escape from the chamber while a [category 3 krasis](Інструменти%20ДМ/CLI/bestiary/monstrosity/category-3-krasis-ggr.md) runs amok through it after breaking out of its growth pod. |
