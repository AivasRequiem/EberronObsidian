...
|-----------|---------------|
| 1 | You were [charmed](Інструменти%20ДМ/CLI/rules/conditions.md#Charmed) or [frightened](Інструменти%20ДМ/CLI/rules/conditions.md#Frightened) by a spell. |
...
| 7 | You turned [invisible](Інструменти%20ДМ/CLI/rules/conditions.md#Invisible) for a time. |
