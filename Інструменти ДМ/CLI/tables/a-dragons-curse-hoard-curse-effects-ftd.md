...
|----------|--------------------|
| 1 | Each affected creature gains 1 level of [exhaustion](Інструменти%20ДМ/CLI/rules/conditions.md#Exhaustion) that can't be removed until the curse is broken. |
