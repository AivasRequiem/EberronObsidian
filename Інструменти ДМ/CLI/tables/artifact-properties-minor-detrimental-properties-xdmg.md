...
| 25–32 | While attuned to the Artifact, you have the [Blinded](Інструменти%20ДМ/CLI/rules/conditions.md#Blinded) condition when you're more than 10 feet away from it. |
| 33–40 | While attuned to the Artifact, you have the [Deafened](Інструменти%20ДМ/CLI/rules/conditions.md#Deafened) condition when you're more than 10 feet away from it. |
...
| 77–80 | While you're attuned to the Artifact, all [Holy Water](Інструменти%20ДМ/CLI/items/holy-water-xphb.md) within 10 feet of you is destroyed. |
...
| 93–00 | While you're attuned to the Artifact, Beasts within 30 feet of you that have a Challenge Rating of 6 or lower are [Hostile](Інструменти%20ДМ/CLI/rules/variant-rules/hostile-attitude-xphb.md) toward you. |
^minor-detrimental-properties