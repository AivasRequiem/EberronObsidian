...
![Guild Adventures](Інструменти%20ДМ/CLI/tables/guild-adventures-erlw.md)
...
![Rival Outfit; Group Rivals](Інструменти%20ДМ/CLI/tables/rival-outfit-group-rivals-erlw.md)
...
![Head of State Contacts; State Contacts](Інструменти%20ДМ/CLI/tables/head-of-state-contacts-state-contacts-erlw.md)
...
![Sora Kell and a Dreamer](Інструменти%20ДМ/CLI/books/eberron-rising-from-the-last-war/img/062-1-47.webp#center)
...
![Patron Benefits; Contacts](Інструменти%20ДМ/CLI/tables/patron-benefits-contacts-erlw.md)
...
![](Інструменти%20ДМ/CLI/books/eberron-rising-from-the-last-war/img/063-1-48.webp#center)
...
![Clientele](Інструменти%20ДМ/CLI/tables/clientele-erlw.md)
...
![Newspaper Contact](Інструменти%20ДМ/CLI/tables/newspaper-contact-erlw.md)
...
![](Інструменти%20ДМ/CLI/books/eberron-rising-from-the-last-war/img/066-1-51.webp#center)
...
**Proficiencies**. Each member of your party gains proficiency in the [Religion](Інструменти%20ДМ/CLI/rules/skills.md#Religion) skill, if the character doesn't already have it.
...
![Serving the Order; Religious Service](Інструменти%20ДМ/CLI/tables/serving-the-order-religious-service-erlw.md)
...
![Hierarchy; Order Reputation](Інструменти%20ДМ/CLI/tables/hierarchy-order-reputation-erlw.md)
...
![Religious Order Contacts; Order Contact](Інструменти%20ДМ/CLI/tables/religious-order-contacts-order-contact-erlw.md)
...
![Morgrave University](Інструменти%20ДМ/CLI/books/eberron-rising-from-the-last-war/img/067-1-52.webp#center)

**Financier**. Whether they're hunting for grants or seeking donations from wealthy philanthropists, the Financier seeks the funds to pay for academic expeditions. Such characters might know their ways around ballrooms, boardrooms, and seedy taverns, willing to do whats necessary to get what they need. Those in this role often exude Charisma and might be adept with the [Deception](Інструменти%20ДМ/CLI/rules/skills.md#Deception), [Intimidation](Інструменти%20ДМ/CLI/rules/skills.md#Intimidation), and [Persuasion](Інструменти%20ДМ/CLI/rules/skills.md#Persuasion) skills. Bards and rogues make natural academic Financiers, as do those with the charlatan and noble backgrounds.
...
![Scholarly Missions](Інструменти%20ДМ/CLI/tables/scholarly-missions-erlw.md)
...
![Scholarly Standing](Інструменти%20ДМ/CLI/tables/scholarly-standing-erlw.md)
...
![University Contact](Інструменти%20ДМ/CLI/tables/university-contact-erlw.md)
