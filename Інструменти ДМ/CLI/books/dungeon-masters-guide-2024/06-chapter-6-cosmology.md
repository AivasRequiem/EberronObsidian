...
![The Lady of Pain appears w...](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/084-06-001-the-lady-of-pain.webp#center "The Lady of Pain appears without warning in the bustling streets of Sigil, and the city's residents get out of her way")
...
![Outer Planes](Інструменти%20ДМ/CLI/tables/outer-planes-xdmg.md)
...
![](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/085-06-002-the-multiverse.webp#center)
...
A number of spells allow direct or indirect access to different planes of existence. [Gate](Інструменти%20ДМ/CLI/spells/gate-xphb.md) and [Plane Shift](Інструменти%20ДМ/CLI/spells/plane-shift-xphb.md) can directly transport adventurers to any other plane, with different degrees of precision. [Etherealness](Інструменти%20ДМ/CLI/spells/etherealness-xphb.md) allows adventurers to enter the Ethereal Plane. And [Astral Projection](Інструменти%20ДМ/CLI/spells/astral-projection-xphb.md) lets adventurers project themselves into the Astral Plane and from there travel to the Outer Planes.
...
![A portal to the Beastlands...](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/086-06-003-portal-to-the-beastlands.webp#center "A portal to the Beastlands opens amid the branches of the World Tree")
...
![Planar Adventure Situations](Інструменти%20ДМ/CLI/tables/planar-adventure-situations-xdmg.md)
...
![Layers of the Abyss](Інструменти%20ДМ/CLI/tables/layers-of-the-abyss-xdmg.md)
...
![The detritus of the Planes...](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/087-06-004-demonweb-pits.webp#center "The detritus of the Planes is tangled in the Demonweb Pits")
...
![Layers of Acheron](Інструменти%20ДМ/CLI/tables/layers-of-acheron-xdmg.md)
...
![Layers of Arborea](Інструменти%20ДМ/CLI/tables/layers-of-arborea-xdmg.md)
...
![](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/088-06-005-arcadia.webp#center)
...
![Layers of Arcadia](Інструменти%20ДМ/CLI/tables/layers-of-arcadia-xdmg.md)
...
![Astral Color Pools](Інструменти%20ДМ/CLI/tables/astral-color-pools-xdmg.md)
...
![Psychic Wind Location Effects](Інструменти%20ДМ/CLI/tables/psychic-wind-location-effects-xdmg.md)
...
![Psychic Wind Psychic Effects](Інструменти%20ДМ/CLI/tables/psychic-wind-psychic-effects-xdmg.md)
...
![Layers of Bytopia](Інструменти%20ДМ/CLI/tables/layers-of-bytopia-xdmg.md)
...
![Layers of Carceri](Інструменти%20ДМ/CLI/tables/layers-of-carceri-xdmg.md)

#### Prison Plane

![Unknown horrors are entrap...](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/090-06-007-ice-of-carceri.webp#center "Unknown horrors are entrapped in the ice of Carceri")

No one can leave Carceri easily. Magical efforts to leave the plane by any spell other than [Wish](Інструменти%20ДМ/CLI/spells/wish-xphb.md) simply fail. Portals and gates that open onto the plane become one-way only. Secret passages out of the plane exist, but they are hidden and well guarded by traps and deadly monsters. And though the River Styx flows between Carceri and its neighbors, the passage is extremely dangerous, and ferries leading out of Carceri are both rare and expensive.
...
![Aarakocra scouts return ho...](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/091-06-008-plane-of-air.webp#center "Aarakocra scouts return home to a city on the Plane of Air")
...
Built atop a tall basalt crag in the middle of a lava river is an iron-walled tavern that is most easily reached by hot-air balloon. The proprietor is a sentient [Flame Tongue (Mace)](Інструменти%20ДМ/CLI/items/flame-tongue-xdmg.md) named Torchy, who sells a fine ale and seems to have a new wielder every few months. Torchy's is a popular hangout for ballooning enthusiasts.
...
![The City of Brass is a hub...](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/092-06-009-city-of-brass.webp#center "The City of Brass is a hub for trade from across the multiverse")
...
![Layers of Elysium](Інструменти%20ДМ/CLI/tables/layers-of-elysium-xdmg.md)
...
Belierin is said to be the prison of some deadly creature. Some tales say it's a powerful titan, perhaps the [tarrasque](Інструменти%20ДМ/CLI/bestiary/monstrosity/tarrasque-xmm.md), while others claim it's a deposed duke of the Nine Hells, a banished elemental prince, or even a near-dead deity. Evil creatures sometimes lurk in the marshes, seeking to free the prisoner or claim some power from it.
...
Characters can use the [Etherealness](Інструменти%20ДМ/CLI/spells/etherealness-xphb.md) spell to enter the Border Ethereal. The [Plane Shift](Інструменти%20ДМ/CLI/spells/plane-shift-xphb.md) spell allows transport to the Border Ethereal or the Deep Ethereal, but unless the intended destination is a specific location or a teleportation circle, the point of arrival could be anywhere on the plane.
...
To reach the Deep Ethereal, one typically needs a [Plane Shift](Інструменти%20ДМ/CLI/spells/plane-shift-xphb.md) spell, a [Gate](Інструменти%20ДМ/CLI/spells/gate-xphb.md) spell, or a magical portal. Visitors to the Deep Ethereal are engulfed by roiling mist. Scattered throughout the plane are curtains of vaporous color, and passing through a curtain leads a traveler to a region of the Border Ethereal connected to a specific Inner Plane, the Material Plane, the Feywild, or the Shadowfell. The color of the curtain indicates the plane whose Border Ethereal the curtain conceals; see the Ethereal Curtains table. The curtains are also distinguishable by texture and temperature, each one reflecting something of the nature of the plane beyond.

![The Radiant Citadel is a r...](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/093-06-010-the-radiant-citadel.webp#center "The Radiant Citadel is a refuge in the Ethereal Plane, despite its proximity to a raging ether cyclone")

![Deep Ethereal; Ethereal Curtains](Інструменти%20ДМ/CLI/tables/deep-ethereal-ethereal-curtains-xdmg.md)
...
![](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/094-06-011-lotus.webp#center)
...
![When the Dragon's Tear com...](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/095-06-012-the-vast-gate.webp#center "When the Dragon's Tear comet appears above Firestorm Peak, the Vast Gate forms a bridge to the Far Realm")
...
Whenever a creature or group of creatures leaves the Feywild after spending at least 1 day on that plane, you can choose a time change that works best for your campaign, if any, or roll on the Feywild Time Warp table. A [Wish](Інструменти%20ДМ/CLI/spells/wish-xphb.md) spell can be used to remove the effect on up to ten creatures. Some powerful Fey have the ability to grant such wishes and might do so if the beneficiaries agree to subject themselves to a [Geas](Інструменти%20ДМ/CLI/spells/geas-xphb.md) spell and complete a quest after the *Wish* spell is cast.

![Feywild Time Warp](Інструменти%20ДМ/CLI/tables/feywild-time-warp-xdmg.md)
...
![Fey revel in the Gloaming ...](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/096-06-013-the-gloaming-court.webp#center "Fey revel in the Gloaming Court under the watchful eye of the Queen of Air and Darkness")
...
![Layers of Gehenna](Інструменти%20ДМ/CLI/tables/layers-of-gehenna-xdmg.md)
...
![Layers of Hades](Інструменти%20ДМ/CLI/tables/layers-of-hades-xdmg.md)

#### Plane of Gloom

At the end of each Long Rest taken on the plane, a visitor makes a DC 10 Wisdom saving throw. On a failed save, the creature gains 1 [Exhaustion](Інструменти%20ДМ/CLI/rules/conditions.md#Exhaustion) level that can't be removed while the creature is in Hades. If the creature reaches 6 Exhaustion levels, it doesn't die. Instead, it permanently transforms into a [Larva](Інструменти%20ДМ/CLI/bestiary/fiend/larva-xmm.md), whereupon all Exhaustion levels afflicting the creature are removed.
...
![With its magical marvels o...](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/097-06-014-eberron-technology.webp#center "With its magical marvels of technology, Eberron is one of countless worlds on the Material Plane")
...
![The Seven Heavens of Mount...](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/098-06-015-mount-celestia.webp#center "The Seven Heavens of Mount Celestia beckon virtuous souls toward ever-greater heights")

![Layers of Mount Celestia](Інструменти%20ДМ/CLI/tables/layers-of-mount-celestia-xdmg.md)
...
In some locations on the Negative Plane, the intensity of the plane is so great that the negative energy folds in on itself, stabilizing into solid chunks of matter that devour light. These chunks, called voidstones, are thought to be the source of [Spheres of Annihilation](Інструменти%20ДМ/CLI/items/sphere-of-annihilation-xdmg.md) and similar magical effects. Anything that comes into contact with a voidstone is destroyed in seconds.
...
![Layers of the Nine Hells](Інструменти%20ДМ/CLI/tables/layers-of-the-nine-hells-xdmg.md)

#### Avernus

![The first of Nine Hells, A...](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/099-06-016-avernus.webp#center "The first of Nine Hells, Avernus, is an eternal battlefield in the Blood War")
...
![Asmodeus, the Lord of the ...](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/100-06-017-asmodeus.webp#center "Asmodeus, the Lord of the Nine, maintains a veneer of pleasantry while inflicting agony on imprisoned souls")
...
![Gate-Towns of the Outlands](Інструменти%20ДМ/CLI/tables/gate-towns-of-the-outlands-xdmg.md)
...
![Layers of Pandemonium](Інструменти%20ДМ/CLI/tables/layers-of-pandemonium-xdmg.md)
...
![Three adventurers brave th...](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/101-06-018-winds-of-pandemonium.webp#center "Three adventurers brave the howling winds of Pandemonium in search of Howler's Crag")
...
![The Shadowfell is a realm ...](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/102-06-019-the-shadowfell.webp#center "The Shadowfell is a realm of death, despair, and dread")
...
![In the cosmopolitan street...](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/103-06-020-citizens-of-sigil.webp#center "In the cosmopolitan streets of Sigil, creatures from across the multiverse coexist in uneasy peace")
...
![Layers of Ysgard](Інструменти%20ДМ/CLI/tables/layers-of-ysgard-xdmg.md)
