...
![The arrival of a mind flay...](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/060-04-001-nautiloid.webp#center "The arrival of a mind flayer nautiloid means trouble for any world—and adventure for that world's heroes!")
...
![Download PDF](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/061-04-002-campaign-journal-sheet.webp#center)
...
![Download PDF](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/062-04-003-dms-character-tracker-sheet.webp#center)
...
![Download PDF](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/063-04-004-campaign-conflicts-sheet.webp#center)
...
![Fortresses on the backs of...](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/064-04-005-dragon-turtle-fortress.webp#center "Fortresses on the backs of dragon turtles rise from the depths, heralding the return of a long-lost dynasty")
...
- **School of Necromancy.** [Vampires](Інструменти%20ДМ/CLI/bestiary/undead/vampire-xmm.md) open a college of necromancy, attracting evil necromancers who need fresh corpses for their studies. An order of vampire hunters seeks the characters' help.  
- **Undying Monarch.** A venerable monarch clings to power by worshiping "Orcus" and becoming a [lich](Інструменти%20ДМ/CLI/bestiary/undead/lich-xmm.md).  
...
![The bold adventurer Murlyn...](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/065-04-006-murlynd.webp#center "The bold adventurer Murlynd has visited many worlds and has a fondness for six-shooters and talking clocks")
...
- **The Waking Deep.** A monstrous horror slumbering in the depths of the ocean stirs, driving minions such as sahuagin, [merrows](Інструменти%20ДМ/CLI/bestiary/monstrosity/merrow-xmm.md), or [dragon turtles](Інструменти%20ДМ/CLI/bestiary/dragon/dragon-turtle-xmm.md) to attack seafaring vessels.  
...
![Using a Published Setting; D&D Settings](Інструменти%20ДМ/CLI/tables/using-a-published-setting-d-d-settings-xdmg.md)
...
- **How Common Is Magic?.** Spellcasters and magic item shops might be common, rare, or practically nonexistent in your world. How readily available are spells such as [Lesser Restoration](Інструменти%20ДМ/CLI/spells/lesser-restoration-xphb.md), [Raise Dead](Інструменти%20ДМ/CLI/spells/raise-dead-xphb.md), and [Teleportation Circle](Інструменти%20ДМ/CLI/spells/teleportation-circle-xphb.md)? Is magic so widespread that it's part of daily life, or so rare that it conjures all sorts of superstitions?  
...
![A time of sorrow can bring...](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/066-04-007-time-of-sorrow.webp#center "A time of sorrow can bring people together and even launch an adventuring party")
...
![Linking Adventures; Adventure Connections](Інструменти%20ДМ/CLI/tables/linking-adventures-adventure-connections-xdmg.md)
...
![In the Dragonlance setting...](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/067-04-008-dragonlance-inn.webp#center "In the Dragonlance setting, Tanis and Tika call their local inn home: a place to see familiar faces like Fizban the Fabulous")
...
![Months and Festivals; Days of the Week](Інструменти%20ДМ/CLI/tables/months-and-festivals-days-of-the-week-xdmg.md)
...
![Gods of Greyhawk](Інструменти%20ДМ/CLI/tables/gods-of-greyhawk-xdmg.md)

### Free City of Greyhawk

> [!gallery]
> ![The Free City of Greyhawk](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/070-map-5-01-city-of-greyhawk.webp#gallery)
> ![Player Version](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/071-map-5-01-city-of-greyhawk-player.webp#gallery)
...
![White Plume Mountain is a ...](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/072-05-004-white-plume-mountain.webp#center "White Plume Mountain is a natural wonder—and a haunt of evil")
...
![The Free City of Greyhawk ...](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/073-05-005-city-of-greyhawk.webp#center "The Free City of Greyhawk rises up behind the teeming city docks")
...
The Free City of Greyhawk is ruled by a council called the Directing Oligarchy, made up of sixteen coequal rulers. This council elects its chief officer, the lord mayor—a position currently held by a human [Spy Master](Інструменти%20ДМ/CLI/bestiary/humanoid/spy-master-xmm.md) (Lawful Neutral) named Nerof Gasgol. The other directors include the captain-general and constable of the City Watch, several guild masters, priests of Boccob and Rao, the inspector of taxes, and a few influential magic-users with ties to politically active secret societies. Several of these directors represent criminal or unsavory interests, including Nerof Gasgol himself, who achieved his position and wealth as the owner of a notorious gambling den.

##### City Watch

The City Watch is a standing garrison of some eight hundred [Guards](Інструменти%20ДМ/CLI/bestiary/humanoid/guard-xmm.md) and [Veteran Warriors](Інструменти%20ДМ/CLI/bestiary/humanoid/warrior-veteran-xmm.md). Bolstering these defenders are [Mages](Інструменти%20ДМ/CLI/bestiary/humanoid/mage-xmm.md) from the city's Guild of Wizardry, as well as [Priests](Інструменти%20ДМ/CLI/bestiary/humanoid/priest-xmm.md) from local temples.
...
The captain-general of the City Watch is Sental Nurev, a tall, human [Warrior Veteran](Інструменти%20ДМ/CLI/bestiary/humanoid/warrior-veteran-xmm.md) (Neutral Good) with thinning blond hair and a mustache. Sental is usually incorruptible, but he is under great stress. The rulers of Stoink, a fortified town in the Bandit Kingdoms, have captured Sental's brother Sarek and are forcing the captain-general to provide information about Greyhawk's defenses and local politicians. Sental gives this information to a human [Spy](Інструменти%20ДМ/CLI/bestiary/humanoid/spy-xmm.md) (Chaotic Evil) who stays at the Black Dragon Inn under the false name Skanda Drond. Sental is unaware that the bandit lords of Stoink are pawns of Iuz, whose dreams of conquest extend to the Free City of Greyhawk and far beyond.

The city's constable—who serves as second-in-command to the captain-general, manager to the members of the watch, and a member of the Directing Oligarchy—is a compassionate [Priest](Інструменти%20ДМ/CLI/bestiary/humanoid/priest-xmm.md) of Pelor named Derider Fanshen (Neutral Good). Her kindness and talent for healing make her well loved among the watch, and as a former adventurer, she is sympathetic to adventurers' needs. She's unaware of Sental's compromised position.

###### Character Backgrounds

Adventurers with the [Criminal](Інструменти%20ДМ/CLI/backgrounds/criminal-xphb.md) or [Guard](Інструменти%20ДМ/CLI/backgrounds/guard-xphb.md) background might have a connection to the Grand Citadel involving a past run-in with the law or past service on the watch.
...
Weapons and armor aren't permitted in the Great Library. If anyone wearing armor or carrying a visible weapon tries to enter the library, or if a thief is spotted trying to leave the library with one or more stolen books, the stone-carved bronze dragons flanking the entrance animate and attack. These statues are [Stone Golems](Інструменти%20ДМ/CLI/bestiary/construct/stone-golem-xmm.md).

Abra Saghast, a crusty and irascible dragonborn sage, serves as the head librarian. Abra, an [Archmage](Інструменти%20ДМ/CLI/bestiary/humanoid/archmage-xmm.md) (Chaotic Good), has bright-green eyes, and her bronze scales are tinged with aquamarine blue. She typically wears a patchwork robe.
...
An iron door leads to a hallway behind the head librarian's desk. Three scribes ([Mages](Інструменти%20ДМ/CLI/bestiary/humanoid/mage-xmm.md)) labor here and act as sentries, for next to their desks are three locked, iron doors to the library's vaults. [Arcane Lock](Інструменти%20ДМ/CLI/spells/arcane-lock-xphb.md) spells seal these doors, beyond which are repositories for the library's most valuable or scandalous works. Next to each scribe's desk is a pull cord hanging through a hole in the ceiling. A tug on any one of these cords releases a homing pigeon from a loft above the library. It takes the bird 1 minute to find and alert an [Archmage](Інструменти%20ДМ/CLI/bestiary/humanoid/archmage-xmm.md), who teleports to the main hall of the library to investigate.

###### Character Backgrounds

Adventurers with the [Sage](Інструменти%20ДМ/CLI/backgrounds/sage-xphb.md) or [Scribe](Інструменти%20ДМ/CLI/backgrounds/scribe-xphb.md) background might have a connection to the Great Library and its proprietor.
...
- **Spell Scrolls.** Adventurers can commission the scribes to create a [Spell Scroll](Інструменти%20ДМ/CLI/items/spell-scroll-xdmg.md) that bears a Wizard spell of level 5 or lower. See the "Player's Handbook" for the time required to "craft a scroll"; the scribes charge double the cost shown there.  
...
Adventurers with the [Merchant](Інструменти%20ДМ/CLI/backgrounds/merchant-xphb.md) or [Noble](Інструменти%20ДМ/CLI/backgrounds/noble-xphb.md) background might have a connection to the High Tower Inn, which caters to people of means.
...
![The Silver Dragon Inn is a...](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/074-05-006-silver-dragon-inn.webp#center "The Silver Dragon Inn is a lively hub of activity in Greyhawk's Foreign Quarter")
...
Weapons larger than daggers must be checked at the door, together with shields. Customers wearing metal armor aren't admitted. Two bouncers (Neutral [Tough Bosses](Інструменти%20ДМ/CLI/bestiary/humanoid/tough-boss-xmm.md)) stand at the door, politely enforcing the rule.

The inn's married human proprietors, Olaf Al-Azul (Chaotic Good [Warrior Veteran](Інструменти%20ДМ/CLI/bestiary/humanoid/warrior-veteran-xmm.md)) and Sivan Al-Azul (Chaotic Neutral [Assassin](Інструменти%20ДМ/CLI/bestiary/humanoid/assassin-xmm.md)), speak multiple languages and use humor to raise spirits and diffuse tensions. Olaf can almost always break up a fight before it starts, generally with a round of drinks for the instigators. Sivan is quiet and introspective, but he always keeps a hilarious joke or cutting remark at the ready.

###### Character Backgrounds

Adventurers with the [Artisan](Інструменти%20ДМ/CLI/backgrounds/artisan-xphb.md) or [Entertainer](Інструменти%20ДМ/CLI/backgrounds/entertainer-xphb.md) background might do business with the Silver Dragon Inn.
...
Situated in the Garden Quarter, this temple is dedicated to Fharlanghn, a god favored by travelers and mercenaries. The [Priests](Інструменти%20ДМ/CLI/bestiary/humanoid/priest-xmm.md) who staff the temple offer nourishment, rest, and healing to those in need, day and night. Several small rooms are maintained for guests, and simple, hot meals are free to all visitors.

###### Character Backgrounds

Adventurers with the [Guide](Інструменти%20ДМ/CLI/backgrounds/guide-xphb.md) or [Sailor](Інструменти%20ДМ/CLI/backgrounds/sailor-xphb.md) background might have a connection to the temple, which offers help to travelers.
...
This temple, dedicated to serving the god Pelor in the heart of the Garden Quarter, opens at dawn and closes at dusk. In a sanctuary in the heart of the temple, [Priests](Інструменти%20ДМ/CLI/bestiary/humanoid/priest-xmm.md) conduct daily morning rites, as well as all-day observances every Godsday.

Sarana, the temple's [Archpriest](Інструменти%20ДМ/CLI/bestiary/humanoid/archpriest-xmm.md) (Neutral Good), is a middle-aged, human woman wearing a sun-shaped headdress and yellow-and-gold robes. She is never seen in public without her [Staff of Healing](Інструменти%20ДМ/CLI/items/staff-of-healing-xdmg.md). Sarana has straw-colored hair, green eyes, and a forgiving nature.

###### Character Backgrounds

Adventurers with the [Acolyte](Інструменти%20ДМ/CLI/backgrounds/acolyte-xphb.md) background might have served in the Temple of the Radiant Sun, while those with the Farmer background might seek it out as a place for blessing.
...
![](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/075-05-007-bookshelf.webp#center)
...
Adventurers with the [Charlatan](Інструменти%20ДМ/CLI/backgrounds/charlatan-xphb.md) or [Hermit](Інструменти%20ДМ/CLI/backgrounds/hermit-xphb.md) background might have a connection to Unearthed Arcana, as Morley has a variety of unusual interests.
...
- **Magic Item Identification.** Morley can cast the [Identify](Інструменти%20ДМ/CLI/spells/identify-xphb.md) spell at will. He charges 50 GP for each casting of the spell.  

#### Beyond the City Walls

> [!gallery]
> ![City of Greyhawk and Environs](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/076-map-5-02-greyhawk-and-environs.webp#gallery)
> ![Player Version](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/077-map-5-02-greyhawk-and-environs-player.webp#gallery)
...
- **Mistmarsh.** This vast swamp holds the half-sunken ruins of an ancient city that is now shrouded by fog and guarded by a family of black dragons. [Will-o'-wisps](Інструменти%20ДМ/CLI/bestiary/undead/will-o-wisp-xmm.md) lure prey to the ruins, where doom awaits.  
...
> [!gallery]
> ![Flanaess](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/078-map-5-03-flanaess.webp#gallery)
> ![Player Version](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/079-map-5-03-flanaess-player.webp#gallery)
...
> - **Scholarly Expertise.** Characters who have proficiency in the [Arcana](Інструменти%20ДМ/CLI/rules/skills.md#Arcana), [History](Інструменти%20ДМ/CLI/rules/skills.md#History), or [Religion](Інструменти%20ДМ/CLI/rules/skills.md#Religion) skill can be fonts of useful information. When it would be helpful for a group to know something about the setting, ask such characters to make an Intelligence check using the relevant skill, then share plot-relevant details if their roll warrants it.  
> - **Magical Footnotes.** Spells such as [Contact Other Plane](Інструменти%20ДМ/CLI/spells/contact-other-plane-xphb.md), [Legend Lore](Інструменти%20ДМ/CLI/spells/legend-lore-xphb.md), and [Speak with Dead](Інструменти%20ДМ/CLI/spells/speak-with-dead-xphb.md) allow characters to learn information while leaving you control of the particulars.  
...
![The Holy Days of Rao are o...](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/080-05-008-holy-days-of-rao.webp#center "The Holy Days of Rao are occasions for joyful processions and festivals in Veluna")
...
![Central Flanaess Locations](Інструменти%20ДМ/CLI/tables/central-flanaess-locations-xdmg.md)
...
![Eastern Flanaess Locations](Інструменти%20ДМ/CLI/tables/eastern-flanaess-locations-xdmg.md)
...
![The Tomb of Horrors lies d...](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/081-05-009-tomb-of-horrors.webp#center "The Tomb of Horrors lies deep within the vast swamp")
...
![Northern Flanaess Locations](Інструменти%20ДМ/CLI/tables/northern-flanaess-locations-xdmg.md)
...
![Adventurers in the North K...](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/082-05-010-mammoth-north-kingdoms.webp#center "Adventurers in the North Kingdoms help a frost giant's pet mammoth find its way home")
...
![Old Keoland Locations](Інструменти%20ДМ/CLI/tables/old-keoland-locations-xdmg.md)
...
![Beneath the beautiful surf...](Інструменти%20ДМ/CLI/books/dungeon-masters-guide-2024/img/083-05-011-hellfurnaces.webp#center "Beneath the beautiful surface of the Hellfurnaces lie endless hidden evils")
...
![Western Flanaess Locations](Інструменти%20ДМ/CLI/tables/western-flanaess-locations-xdmg.md)
