...
![Character Options; Subclasses](Інструменти%20ДМ/CLI/tables/character-options-subclasses-xge.md)
...
![](Інструменти%20ДМ/CLI/books/xanathars-guide-to-everything/img/c1039.webp#center)
...
![Parents](Інструменти%20ДМ/CLI/tables/parents-xge.md)

![Half-Elf Parents](Інструменти%20ДМ/CLI/tables/half-elf-parents-xge.md)

![Half-Orc Parents](Інструменти%20ДМ/CLI/tables/half-orc-parents-xge.md)

![Tiefling Parents](Інструменти%20ДМ/CLI/tables/tiefling-parents-xge.md)
...
![Birthplace](Інструменти%20ДМ/CLI/tables/birthplace-xge.md)
...
![Number of Siblings](Інструменти%20ДМ/CLI/tables/number-of-siblings-xge.md)

![Other Details; Birth Order](Інструменти%20ДМ/CLI/tables/other-details-birth-order-xge.md)
...
![](Інструменти%20ДМ/CLI/books/xanathars-guide-to-everything/img/c1040.webp#center)
...
![Supplemental Tables; Family](Інструменти%20ДМ/CLI/tables/supplemental-tables-family-xge.md)

![Supplemental Tables; Absent Parent](Інструменти%20ДМ/CLI/tables/supplemental-tables-absent-parent-xge.md)

![Supplemental Tables; Family Lifestyle](Інструменти%20ДМ/CLI/tables/supplemental-tables-family-lifestyle-xge.md)

![Supplemental Tables; Childhood Home](Інструменти%20ДМ/CLI/tables/supplemental-tables-childhood-home-xge.md)

![Supplemental Tables; Childhood Memories](Інструменти%20ДМ/CLI/tables/supplemental-tables-childhood-memories-xge.md)
...
![](Інструменти%20ДМ/CLI/books/xanathars-guide-to-everything/img/c1041.webp#center)
...
![](Інструменти%20ДМ/CLI/books/xanathars-guide-to-everything/img/c1042.webp#center)
...
![](Інструменти%20ДМ/CLI/books/xanathars-guide-to-everything/img/c1043.webp#center)
...
![Life Events by Age](Інструменти%20ДМ/CLI/tables/life-events-by-age-xge.md)

![Life Events](Інструменти%20ДМ/CLI/tables/life-events-xge.md)

#### Secondary Tables

These tables add detail to many of the results on the Life Events table. The tables are in alphabetical order.

![Secondary Tables; Adventures](Інструменти%20ДМ/CLI/tables/secondary-tables-adventures-xge.md)

![Secondary Tables; Arcane Matters](Інструменти%20ДМ/CLI/tables/secondary-tables-arcane-matters-xge.md)

![Secondary Tables; Boons](Інструменти%20ДМ/CLI/tables/secondary-tables-boons-xge.md)

![Secondary Tables; Crime](Інструменти%20ДМ/CLI/tables/secondary-tables-crime-xge.md)

![Secondary Tables; Punishment](Інструменти%20ДМ/CLI/tables/secondary-tables-punishment-xge.md)

![Secondary Tables; Supernatural Events](Інструменти%20ДМ/CLI/tables/secondary-tables-supernatural-events-xge.md)

![Secondary Tables; Tragedies](Інструменти%20ДМ/CLI/tables/secondary-tables-tragedies-xge.md)

![Secondary Tables; War](Інструменти%20ДМ/CLI/tables/secondary-tables-war-xge.md)

![Secondary Tables; Weird Stuff](Інструменти%20ДМ/CLI/tables/secondary-tables-weird-stuff-xge.md)
...
![](Інструменти%20ДМ/CLI/books/xanathars-guide-to-everything/img/c1044.webp#center)

![Supplemental Tables; Alignment](Інструменти%20ДМ/CLI/tables/supplemental-tables-alignment-xge.md)

![Supplemental Tables; Cause of Death](Інструменти%20ДМ/CLI/tables/supplemental-tables-cause-of-death-xge.md)

![Supplemental Tables; Class](Інструменти%20ДМ/CLI/tables/supplemental-tables-class-xge.md)

![Supplemental Tables; Occupation](Інструменти%20ДМ/CLI/tables/supplemental-tables-occupation-xge.md)

![Supplemental Tables; Race](Інструменти%20ДМ/CLI/tables/supplemental-tables-race-xge.md)

![Supplemental Tables; Relationship](Інструменти%20ДМ/CLI/tables/supplemental-tables-relationship-xge.md)

![Supplemental Tables; Status](Інструменти%20ДМ/CLI/tables/supplemental-tables-status-xge.md)
...
![Racial Feats](Інструменти%20ДМ/CLI/tables/racial-feats-xge.md)

![](Інструменти%20ДМ/CLI/books/xanathars-guide-to-everything/img/c1045.webp#center)