...
Characters can use their monetary treasure to purchase anything from the equipment lists in chapter 5 of the "Player's Handbook". In addition, the Adventurers League allows characters to purchase potions and spell scrolls, as detailed below. A [spell scroll](Інструменти%20ДМ/CLI/items/spell-scroll-xdmg.md) can be purchased only by a character who is capable of casting the spell in question.

![Potions for Sale](Інструменти%20ДМ/CLI/tables/potions-for-sale-xge.md)

![Spell Scrolls for Sale](Інструменти%20ДМ/CLI/tables/spell-scrolls-for-sale-xge.md)
