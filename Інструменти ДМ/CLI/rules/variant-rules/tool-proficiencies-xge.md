...
[Alchemist's supplies](Інструменти%20ДМ/CLI/items/alchemists-supplies-xphb.md) enable a character to produce useful concoctions, such as acid or alchemist's fire.

#### Components

[alchemist's supplies](Інструменти%20ДМ/CLI/items/alchemists-supplies-xphb.md) include two glass beakers, a metal frame to hold a beaker in place over an open flame, a glass stirring rod, a small mortar and pestle, and a pouch of common alchemical ingredients, including salt, powdered iron, and purified water.

#### Arcana

Proficiency with [alchemist's supplies](Інструменти%20ДМ/CLI/items/alchemists-supplies-xphb.md) allows you to unlock more information on [Arcana](Інструменти%20ДМ/CLI/rules/skills.md#Arcana) checks involving potions and similar materials.

#### Investigation

When you inspect an area for clues, proficiency with [alchemist's supplies](Інструменти%20ДМ/CLI/items/alchemists-supplies-xphb.md) grants additional insight into any chemicals or other substances that might have been used in the area.

#### Alchemical Crafting

You can use this tool proficiency to create alchemical items. A character can spend money to collect raw materials, which weigh 1 pound for every 50 gp spent. The DM can allow a character to make a check using the indicated skill with advantage. As part of a long rest, you can use [alchemist's supplies](Інструменти%20ДМ/CLI/items/alchemists-supplies-xphb.md) to make one dose of [acid](Інструменти%20ДМ/CLI/items/acid-xphb.md), [alchemist's fire](Інструменти%20ДМ/CLI/items/alchemists-fire-xphb.md), [antitoxin](Інструменти%20ДМ/CLI/items/antitoxin-xphb.md), [oil](Інструменти%20ДМ/CLI/items/oil-xphb.md), [perfume](Інструменти%20ДМ/CLI/items/perfume-xphb.md), or soap. Subtract half the value of the created item from the total gp worth of raw materials you are carrying.
...
[Brewer's supplies](Інструменти%20ДМ/CLI/items/brewers-supplies-xphb.md) include a large glass jug, a quantity of hops, a siphon, and several feet of tubing.

#### History

Proficiency with [brewer's supplies](Інструменти%20ДМ/CLI/items/brewers-supplies-xphb.md) gives you additional insight on Intelligence ([History](Інструменти%20ДМ/CLI/rules/skills.md#History)) checks concerning events that involve alcohol as a significant element.
...
A stiff drink can help soften the hardest heart. Your proficiency with [brewer's supplies](Інструменти%20ДМ/CLI/items/brewers-supplies-xphb.md) can help you ply someone with drink, giving them just enough alcohol to mellow their mood.
...
[Calligrapher's supplies](Інструменти%20ДМ/CLI/items/calligraphers-supplies-xphb.md) include ink, a dozen sheets of parchment, and three quills.
...
[Carpenter's tools](Інструменти%20ДМ/CLI/items/carpenters-tools-xphb.md) include a saw, a hammer, nails, a hatchet, a square, a ruler, an adze, a plane, and a chisel.
...
Using [cartographer's tools](Інструменти%20ДМ/CLI/items/cartographers-tools-xphb.md), you can create accurate maps to make travel easier for yourself and those who come after you. These maps can range from large-scale depictions of mountain ranges to diagrams that show the layout of a dungeon level.

#### Components

[Cartographer's tools](Інструменти%20ДМ/CLI/items/cartographers-tools-xphb.md) consist of a quill, ink, parchment, a pair of compasses, calipers, and a ruler.
...
[Cobbler's tools](Інструменти%20ДМ/CLI/items/cobblers-tools-xphb.md) consist of a hammer, an awl, a knife, a shoe stand, a cutter, spare leather, and thread.
...
As part of a long rest, you can repair your companions' shoes. For the next 24 hours, up to six creatures of your choice who wear shoes you worked on can travel up to 10 hours a day without making saving throws to avoid [exhaustion](Інструменти%20ДМ/CLI/rules/conditions.md#Exhaustion).

#### Craft Hidden Compartment

With 8 hours of work, you can add a hidden compartment to a pair of shoes. The compartment can hold an object up to 3 inches long and 1 inch wide and deep. You make an Intelligence check using your tool proficiency to determine the Intelligence ([Investigation](Інструменти%20ДМ/CLI/rules/skills.md#Investigation)) check DC needed to find the compartment.
...
[Cook's utensils](Інструменти%20ДМ/CLI/items/cooks-utensils-xphb.md) include a metal pot, knives, forks, a stirring spoon, and a ladle.
...
As part of a short rest, you can prepare a tasty meal that helps your companions regain their strength. You and up to five creatures of your choice regain 1 extra hit point per Hit Die spent during a short rest, provided you have access to your [cook's utensils](Інструменти%20ДМ/CLI/items/cooks-utensils-xphb.md) and sufficient food.
...
The perfect tool for anyone who wants to engage in trickery, a [disguise kit](Інструменти%20ДМ/CLI/items/disguise-kit-xphb.md) enables its owner to adopt a false identity.

#### Components

A [disguise kit](Інструменти%20ДМ/CLI/items/disguise-kit-xphb.md) includes cosmetics, hair dye, small props, and a few pieces of clothing.
...
A [forgery kit](Інструменти%20ДМ/CLI/items/forgery-kit-xphb.md) is designed to duplicate documents and to make it easier to copy a person's seal or signature.

#### Components

A [forgery kit](Інструменти%20ДМ/CLI/items/forgery-kit-xphb.md) includes several different types of ink, a variety of parchments and papers, several quills, seals and sealing wax, gold and silver leaf, and small tools to sculpt melted wax to mimic a seal.

#### Arcana

A [forgery kit](Інструменти%20ДМ/CLI/items/forgery-kit-xphb.md) can be used in conjunction with the [Arcana](Інструменти%20ДМ/CLI/rules/skills.md#Arcana) skill to determine if a magic item is real or fake.
...
A [forgery kit](Інструменти%20ДМ/CLI/items/forgery-kit-xphb.md) combined with your knowledge of history improves your ability to create fake historical documents or to tell if an old document is authentic.

#### Investigation

When you examine objects, proficiency with a [forgery kit](Інструменти%20ДМ/CLI/items/forgery-kit-xphb.md) is useful for determining how an object was made and whether it is genuine.

#### Other Tools

Knowledge of other tools makes your forgeries that much more believable. For example, you could combine proficiency with a [forgery kit](Інструменти%20ДМ/CLI/items/forgery-kit-xphb.md) and proficiency with [cartographer's tools](Інструменти%20ДМ/CLI/items/cartographers-tools-xphb.md) to make a fake map.

#### Quick Fake

As part of a short rest, you can produce a forged document no more than one page in length. As part of a long rest, you can produce a document that is up to four pages long. Your Intelligence check using a [forgery kit](Інструменти%20ДМ/CLI/items/forgery-kit-xphb.md) determines the DC for someone else's Intelligence ([Investigation](Інструменти%20ДМ/CLI/rules/skills.md#Investigation)) check to spot the fake.
...
Proficiency with a [gaming set](Інструменти%20ДМ/CLI/items/gaming-set-xphb.md) applies to one type of game, such as Three-Dragon Ante or games of chance that use dice.

#### Components

A [gaming set](Інструменти%20ДМ/CLI/items/gaming-set-xphb.md) has all the pieces needed to play a specific game or type of game, such as a complete deck of cards or a board and tokens.
...
Someone who is proficient with [glassblower's tools](Інструменти%20ДМ/CLI/items/glassblowers-tools-xphb.md) has not only the ability to shape glass, but also specialized knowledge of the methods used to produce glass objects.
...
Proficiency with an [herbalism kit](Інструменти%20ДМ/CLI/items/herbalism-kit-xphb.md) allows you to identify plants and safely collect their useful elements.

#### Components

An [herbalism kit](Інструменти%20ДМ/CLI/items/herbalism-kit-xphb.md) includes pouches to store herbs, clippers and leather gloves for collecting plants, a mortar and pestle, and several glass jars.
...
Training with [jeweler's tools](Інструменти%20ДМ/CLI/items/jewelers-tools-xphb.md) includes the basic techniques needed to beautify gems. It also gives you expertise in identifying precious stones.

#### Components

[Jeweler's tools](Інструменти%20ДМ/CLI/items/jewelers-tools-xphb.md) consist of a small saw and hammer, files, pliers, and tweezers.

#### Arcana

Proficiency with [jeweler's tools](Інструменти%20ДМ/CLI/items/jewelers-tools-xphb.md) grants you knowledge about the reputed mystical uses of gems. This insight proves handy when you make [Arcana](Інструменти%20ДМ/CLI/rules/skills.md#Arcana) checks related to gems or gem-encrusted items.

#### Investigation

When you inspect jeweled objects, your proficiency with [jeweler's tools](Інструменти%20ДМ/CLI/items/jewelers-tools-xphb.md) aids you in picking out clues they might hold.
...
[Leatherworker's tools](Інструменти%20ДМ/CLI/items/leatherworkers-tools-xphb.md) include a knife, a small mallet, an edger, a hole punch, thread, and leather scraps.
...
[Mason's tools](Інструменти%20ДМ/CLI/items/masons-tools-xphb.md) allow you to craft stone structures, including walls and buildings crafted from brick.

#### Components

[Mason's tools](Інструменти%20ДМ/CLI/items/masons-tools-xphb.md) consist of a trowel, a hammer, a chisel, brushes, and a square.
...
Proficiency with a [musical instrument](Інструменти%20ДМ/CLI/items/musical-instrument-xphb.md) indicates you are familiar with the techniques used to play it. You also have knowledge of some songs commonly performed with that instrument.
...
Proficiency with [navigator's tools](Інструменти%20ДМ/CLI/items/navigators-tools-xphb.md) helps you determine a true course based on observing the stars. It also grants you insight into charts and maps while developing your sense of direction.

#### Components

[Navigator's tools](Інструменти%20ДМ/CLI/items/navigators-tools-xphb.md) include a sextant, a compass, calipers, a ruler, parchment, ink, and a quill.

#### Survival

Knowledge of [navigator's tools](Інструменти%20ДМ/CLI/items/navigators-tools-xphb.md) helps you avoid becoming lost and also grants you insight into the most likely location for roads and settlements.
...
Proficiency with [painter's supplies](Інструменти%20ДМ/CLI/items/painters-supplies-xphb.md) represents your ability to paint and draw. You also acquire an understanding of art history, which can aid you in examining works of art.

#### Components

[Painter's supplies](Інструменти%20ДМ/CLI/items/painters-supplies-xphb.md) include an easel, canvas, paints, brushes, charcoal sticks, and a palette.
...
A [poisoner's kit](Інструменти%20ДМ/CLI/items/poisoners-kit-xphb.md) is a favored resource for thieves, assassins, and others who engage in skulduggery. It allows you to apply poisons and create them from various materials. Your knowledge of poisons also helps you treat them.

#### Components

A [poisoner's kit](Інструменти%20ДМ/CLI/items/poisoners-kit-xphb.md) includes glass vials, a mortar and pestle, chemicals, and a glass stirring rod.
...
Your knowledge of poisons has taught you to handle those substances carefully, giving you an edge when you inspect [poisoned](Інструменти%20ДМ/CLI/rules/conditions.md#Poisoned) objects or try to extract clues from events that involve poison.
...
| Activity | DC |
|----------|----|
| Spot a [poisoned](Інструменти%20ДМ/CLI/rules/conditions.md#Poisoned) object | 10 |
| Determine the effects of a poison | 20 |
^poisoners-tools

### Potter's Tools

[Potter's tools](Інструменти%20ДМ/CLI/items/potters-tools-xphb.md) are used to create a variety of ceramic objects, most typically pots and similar vessels.

#### Components

[Potter's tools](Інструменти%20ДМ/CLI/items/potters-tools-xphb.md) include potter's needles, ribs, scrapers, a knife, and calipers.
...
[Smith's tools](Інструменти%20ДМ/CLI/items/smiths-tools-xphb.md) allow you to work metal, heating it to alter its shape, repair damage, or work raw ingots into useful items.

#### Components

[Smith's tools](Інструменти%20ДМ/CLI/items/smiths-tools-xphb.md) include hammers, tongs, charcoal, rags, and a whetstone.
...
Perhaps the most common tools used by adventurers, [thieves' tools](Інструменти%20ДМ/CLI/items/thieves-tools-xphb.md) are designed for picking locks and foiling traps. Proficiency with the tools also grants you a general knowledge of traps and locks.

#### Components

[Thieves' tools](Інструменти%20ДМ/CLI/items/thieves-tools-xphb.md) include a small file, a set of lock picks, a small mirror mounted on a metal handle, a set of narrow-bladed scissors, and a pair of pliers.
...
A set of [tinker's tools](Інструменти%20ДМ/CLI/items/tinkers-tools-xphb.md) is designed to enable you to repair many mundane objects. Though you can't manufacture much with [tinker's tools](Інструменти%20ДМ/CLI/items/tinkers-tools-xphb.md), you can mend torn clothes, sharpen a worn sword, and patch a tattered suit of chain mail.

#### Components

[Tinker's tools](Інструменти%20ДМ/CLI/items/tinkers-tools-xphb.md) include a variety of hand tools, thread, needles, a whetstone, scraps of cloth and leather, and a small pot of glue.
...
[Weaver's tools](Інструменти%20ДМ/CLI/items/weavers-tools-xphb.md) allow you to create cloth and tailor it into articles of clothing.

#### Components

[Weaver's tools](Інструменти%20ДМ/CLI/items/weavers-tools-xphb.md) include thread, needles, and scraps of cloth. You know how to work a loom, but such equipment is too large to transport.
...
[Woodcarver's tools](Інструменти%20ДМ/CLI/items/woodcarvers-tools-xphb.md) allow you to craft intricate objects from wood, such as wooden tokens or arrows.

#### Components

[Woodcarver's tools](Інструменти%20ДМ/CLI/items/woodcarvers-tools-xphb.md) consist of a knife, a gouge, and a small saw.
