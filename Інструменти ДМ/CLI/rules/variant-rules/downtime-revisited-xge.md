...
- [Buying a Magic Item](Інструменти%20ДМ/CLI/rules/variant-rules/downtime-activity-buying-a-magic-item-xge.md)  
- [Carousing](Інструменти%20ДМ/CLI/rules/variant-rules/downtime-activity-carousing-xge.md)  
- [Crafting an Item](Інструменти%20ДМ/CLI/rules/variant-rules/downtime-activity-crafting-an-item-xge.md)  
- [Crime](Інструменти%20ДМ/CLI/rules/variant-rules/downtime-activity-crime-xge.md)  
- [Gambling](Інструменти%20ДМ/CLI/rules/variant-rules/downtime-activity-gambling-xge.md)  
- [Pit Fighting](Інструменти%20ДМ/CLI/rules/variant-rules/downtime-activity-pit-fighting-xge.md)  
- [Relaxation](Інструменти%20ДМ/CLI/rules/variant-rules/downtime-activity-relaxation-xge.md)  
- [Religious Service](Інструменти%20ДМ/CLI/rules/variant-rules/downtime-activity-religious-service-xge.md)  
- [Research](Інструменти%20ДМ/CLI/rules/variant-rules/downtime-activity-research-xge.md)  
- [Scribing a Spell Scroll](Інструменти%20ДМ/CLI/rules/variant-rules/downtime-activity-scribing-a-spell-scroll-xge.md)  
- [Selling a Magic Item](Інструменти%20ДМ/CLI/rules/variant-rules/downtime-activity-selling-a-magic-item-xge.md)  
- [Training](Інструменти%20ДМ/CLI/rules/variant-rules/downtime-activity-training-xge.md)  
- [Work](Інструменти%20ДМ/CLI/rules/variant-rules/downtime-activity-work-xge.md)