...
On each of your subsequent turns, you can take a [Bonus Action](Інструменти%20ДМ/CLI/rules/variant-rules/bonus-action-xphb.md) to deal `dice:1d12|noform|noparens|avg` (`d12`) Lightning damage to the target automatically, even if the first attack missed.
