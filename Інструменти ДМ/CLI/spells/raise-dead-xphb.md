...
![](Інструменти%20ДМ/CLI/spells/img/raise-dead.webp#right)
...
The creature returns to life with 1 [Hit Point](Інструменти%20ДМ/CLI/rules/variant-rules/hit-points-xphb.md). This spell also neutralizes any poisons that affected the creature at the time of death.
