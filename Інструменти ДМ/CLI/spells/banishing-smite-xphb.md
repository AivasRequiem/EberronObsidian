...
**Classes**: [Artificer (Battle Smith)](Інструменти%20ДМ/CLI/lists/list-spells-classes-battle-smith-tce.md "subclass=TCE;class=TCE"); [Paladin](Інструменти%20ДМ/CLI/lists/list-spells-classes-paladin.md); [Warlock (The Hexblade)](Інструменти%20ДМ/CLI/lists/list-spells-classes-the-hexblade-xge.md "subclass=XGE;class=XPHB")
