...
When you drink this potion, you gain the effect of the [Clairvoyance](Інструменти%20ДМ/CLI/spells/clairvoyance-xphb.md) spell (no [Concentration](Інструменти%20ДМ/CLI/rules/conditions.md#Concentration) required).
