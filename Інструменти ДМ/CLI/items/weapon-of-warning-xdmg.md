...
![](Інструменти%20ДМ/CLI/items/img/weapon-of-warning.webp#right)
...
Each subject has [Advantage](Інструменти%20ДМ/CLI/rules/variant-rules/advantage-xphb.md) on its [Initiative](Інструменти%20ДМ/CLI/rules/variant-rules/initiative-xphb.md) rolls.
