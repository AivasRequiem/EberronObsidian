...
While wearing this circlet, you can cast [Scorching Ray](Інструменти%20ДМ/CLI/spells/scorching-ray-xphb.md) with it (`+5` to hit). The circlet can't cast this spell again until the next dawn.
