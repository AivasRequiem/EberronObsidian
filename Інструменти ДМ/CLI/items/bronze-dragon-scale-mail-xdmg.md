...
Additionally, you can focus your senses as a [Magic](Інструменти%20ДМ/CLI/rules/actions.md#Magic) action to discern the distance and direction to the closest bronze dragon within 30 miles of yourself. This action can't be used again until the next dawn.
