...
![](Інструменти%20ДМ/CLI/items/img/baba-yagas-mortar-and-pestle.webp#right)
...
You can also use the artifact as [alchemist's supplies](Інструменти%20ДМ/CLI/items/alchemists-supplies-xphb.md), [brewer's supplies](Інструменти%20ДМ/CLI/items/brewers-supplies-xphb.md), [cook's utensils](Інструменти%20ДМ/CLI/items/cooks-utensils-xphb.md), an [herbalism kit](Інструменти%20ДМ/CLI/items/herbalism-kit-xphb.md), and a [poisoner's kit](Інструменти%20ДМ/CLI/items/poisoners-kit-xphb.md). You have advantage on any check you make using the artifact as one of these tools.
