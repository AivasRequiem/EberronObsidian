...
# Figurine of Wondrous Power, Marble Elephant
*Wondrous item, rare*  
![](Інструменти%20ДМ/CLI/items/img/figurine-of-wondrous-power-marble-elephant.webp#right)
...
This marble statuette resembles a trumpeting elephant. It can become an [Elephant](Інструменти%20ДМ/CLI/bestiary/beast/elephant-xmm.md) for up to 24 hours. Once it has been used, it can't be used again until 7 days have passed.
