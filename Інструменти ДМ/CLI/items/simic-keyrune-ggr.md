...
![](Інструменти%20ДМ/CLI/items/img/simic-keyrune.webp#right)


This keyrune is assembled from coral, mother-of-pearl, and chrome and adorned with the spirals and curves characteristic of Simic ornamentation. The head resembles the shell of a sea creature. On command, the keyrune turns into a [category 1 krasis](Інструменти%20ДМ/CLI/bestiary/monstrosity/category-1-krasis-ggr.md) that has the Grabber and Stabilizing Legs adaptations. The transformation lasts for up to 5 hours.

When you use an action to speak the item's command word and place the keyrune on the ground in an unoccupied space within 5 feet of you, the keyrune transforms into a [category 1 krasis](Інструменти%20ДМ/CLI/bestiary/monstrosity/category-1-krasis-ggr.md) that has the Grabber and Stabilizing Legs adaptations. If there isn't enough space for the creature, the keyrune doesn't transform.
