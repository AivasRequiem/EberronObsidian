...
As an action, you can use the tattoo to cast the [disguise self](Інструменти%20ДМ/CLI/spells/disguise-self-xphb.md) spell (DC 13 to discern the disguise). Once the spell is cast from the tattoo, it can't be cast from the tattoo again until the next dawn.
