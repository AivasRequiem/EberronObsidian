...
![](Інструменти%20ДМ/CLI/items/img/staff-of-healing.webp#right)
...
| Spell | Charge Cost |
|-------|-------------|
| [Cure Wounds](Інструменти%20ДМ/CLI/spells/cure-wounds-xphb.md) | 1 charge per spell level (maximum 4 for a level 4 spell) |
| [Lesser Restoration](Інструменти%20ДМ/CLI/spells/lesser-restoration-xphb.md) | 2 |
| [Mass Cure Wounds](Інструменти%20ДМ/CLI/spells/mass-cure-wounds-xphb.md) | 5 |
^spell-charge-cost
