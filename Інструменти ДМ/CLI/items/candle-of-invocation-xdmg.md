...
![](Інструменти%20ДМ/CLI/items/img/candle-of-invocation.webp#right)


This candle's magic is activated when the candle is lit, which requires a [Magic](Інструменти%20ДМ/CLI/rules/actions.md#Magic) action. After burning for 4 hours, the candle is destroyed. You can snuff it out early for use at a later time. Deduct the time it burned in increments of 1 minute from its total burn time.
