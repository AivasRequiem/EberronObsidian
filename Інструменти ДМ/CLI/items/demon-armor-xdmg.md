...
![](Інструменти%20ДМ/CLI/items/img/demon-armor.webp#right)
...
Once you don this cursed armor, you can't doff it unless you are targeted by a [Remove Curse](Інструменти%20ДМ/CLI/spells/remove-curse-xphb.md) spell or similar magic. While wearing the armor, you have [Disadvantage](Інструменти%20ДМ/CLI/rules/variant-rules/disadvantage-xphb.md) on attack rolls against demons and on saving throws against their spells and special abilities.
