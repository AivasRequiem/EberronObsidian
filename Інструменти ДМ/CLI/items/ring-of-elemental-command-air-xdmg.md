...
![](Інструменти%20ДМ/CLI/items/img/ring-of-elemental-command-air.webp#right)
...
- **Air.** You know Auran, you have [Resistance](Інструменти%20ДМ/CLI/rules/variant-rules/resistance-xphb.md) to Lightning damage, and you have a [Fly Speed](Інструменти%20ДМ/CLI/rules/variant-rules/fly-speed-xphb.md) equal to your [Speed](Інструменти%20ДМ/CLI/rules/variant-rules/speed-xphb.md) and can hover.  
