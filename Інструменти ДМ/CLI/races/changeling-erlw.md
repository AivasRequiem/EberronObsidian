...
![Changeling adopting a person's appearance](Інструменти%20ДМ/CLI/races/img/changeling.webp#right)
...
You gain proficiency with two of the following skills of your choice: [Deception](Інструменти%20ДМ/CLI/rules/skills.md#Deception), [Insight](Інструменти%20ДМ/CLI/rules/skills.md#Insight), [Intimidation](Інструменти%20ДМ/CLI/rules/skills.md#Intimidation), and [Persuasion](Інструменти%20ДМ/CLI/rules/skills.md#Persuasion).
...
![](Інструменти%20ДМ/CLI/races/img/changeling-001.webp#center)