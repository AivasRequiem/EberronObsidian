...
![](Інструменти%20ДМ/CLI/races/img/shifter.webp#right)
...
Channeling the beast within, you have proficiency in one of the following skills of your choice: [Acrobatics](Інструменти%20ДМ/CLI/rules/skills.md#Acrobatics), [Athletics](Інструменти%20ДМ/CLI/rules/skills.md#Athletics), [Intimidation](Інструменти%20ДМ/CLI/rules/skills.md#Intimidation), or [Survival](Інструменти%20ДМ/CLI/rules/skills.md#Survival).
