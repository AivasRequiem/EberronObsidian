...
You have proficiency in the [Survival](Інструменти%20ДМ/CLI/rules/skills.md#Survival) skill.

### Shifting Feature

While shifted, you have advantage on Wisdom checks, and no creature within 30 feet of you can make an attack roll with advantage against you, unless you're [incapacitated](Інструменти%20ДМ/CLI/rules/conditions.md#Incapacitated).
...
![](Інструменти%20ДМ/CLI/races/img/shifter-001.webp#center)