...
![](Інструменти%20ДМ/CLI/races/img/bugbear.webp#right)
...
You are proficient in the [Stealth](Інструменти%20ДМ/CLI/rules/skills.md#Stealth) skill. In addition, without squeezing, you can move through and stop in a space large enough for a Small creature.
