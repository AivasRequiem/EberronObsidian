...
Kalashtar sleep, but they don't connect to the plane of dreams as other creatures do. Instead, their minds draw from the memories of their otherworldly spirit while they sleep. As such, you are immune to spells and other magical effects that require you to dream, like [dream](Інструменти%20ДМ/CLI/spells/dream-xphb.md), but not to spells and other magical effects that put you to sleep, like [sleep](Інструменти%20ДМ/CLI/spells/sleep-xphb.md).
...
![](Інструменти%20ДМ/CLI/races/img/kalashtar-001.webp#center)