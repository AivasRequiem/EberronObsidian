...
You know the [blade ward](Інструменти%20ДМ/CLI/spells/blade-ward-xphb.md) cantrip. You can cast it as normal, and you can also cast it as a bonus action a number of times equal to your proficiency bonus, regaining all expended uses when you finish a long rest.

Starting at 5th level, you can cast the [pass without trace](Інструменти%20ДМ/CLI/spells/pass-without-trace-xphb.md) spell with this trait, without requiring a material component. Once you cast that spell with this trait, you can't do so again until you finish a long rest. You can also cast it using any spell slots you have of 2nd level or higher.
