...
![](Інструменти%20ДМ/CLI/races/img/halfling.webp#right)
...
You have [Advantage](Інструменти%20ДМ/CLI/rules/variant-rules/advantage-xphb.md) on saving throws you make to avoid or end the [Frightened](Інструменти%20ДМ/CLI/rules/conditions.md#Frightened) condition.
...
You can take the [Hide](Інструменти%20ДМ/CLI/rules/actions.md#Hide) action even when you are obscured only by a creature that is at least one size larger than you.
