...
![](Інструменти%20ДМ/CLI/races/img/kenku.webp#right)
...
You can accurately mimic sounds you have heard, including voices. A creature that hears the sounds you make can tell they are imitations only with a successful Wisdom ([Insight](Інструменти%20ДМ/CLI/rules/skills.md#Insight)) check against a DC of 8 + your proficiency bonus + your Charisma modifier.
