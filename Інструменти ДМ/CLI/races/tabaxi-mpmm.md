...
![](Інструменти%20ДМ/CLI/races/img/tabaxi.webp#right)
...
You have proficiency in the [Perception](Інструменти%20ДМ/CLI/rules/skills.md#Perception) and [Stealth](Інструменти%20ДМ/CLI/rules/skills.md#Stealth) skills.
