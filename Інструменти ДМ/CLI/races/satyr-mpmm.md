...
![](Інструменти%20ДМ/CLI/races/img/satyr.webp#right)
...
As an embodiment of revelry, you have proficiency in the [Performance](Інструменти%20ДМ/CLI/rules/skills.md#Performance) and [Persuasion](Інструменти%20ДМ/CLI/rules/skills.md#Persuasion) skills, and you have proficiency with one [musical instrument](Інструменти%20ДМ/CLI/items/musical-instrument-xphb.md) of your choice.
