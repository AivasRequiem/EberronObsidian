...
![](Інструменти%20ДМ/CLI/races/img/changeling.webp#right)
...
Thanks to your connection to the fey realm, you gain proficiency with two of the following skills of your choice: [Deception](Інструменти%20ДМ/CLI/rules/skills.md#Deception), [Insight](Інструменти%20ДМ/CLI/rules/skills.md#Insight), [Intimidation](Інструменти%20ДМ/CLI/rules/skills.md#Intimidation), [Performance](Інструменти%20ДМ/CLI/rules/skills.md#Performance), or [Persuasion](Інструменти%20ДМ/CLI/rules/skills.md#Persuasion).
